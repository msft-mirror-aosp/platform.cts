...
private fun generateTestFile(
    ...
    return """
      ...
      public final class ${policyName}PolicyScopeUser
      ...
      public final class ${policyName}PolicyScopeDevice
      ...
      public final class ${policyName}PolicyScopeParentUser
      ...
      @UsesEnterprisePolicies(
          scopeUser = ${policyName}PolicyScopeUser::class,
          scopeDevice = ${policyName}PolicyScopeDevice::class,
          scopeParentUser = ${policyName}PolicyScopeParentUser::class,
      )
      @ApiTest(
          apis = ${formatArray(apisUnderTest.quoteAll().sorted(), indent="              ")}
      )
