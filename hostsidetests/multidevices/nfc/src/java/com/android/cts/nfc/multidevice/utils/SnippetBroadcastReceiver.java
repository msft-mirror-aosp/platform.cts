...
public class SnippetBroadcastReceiver extends BroadcastReceiver {
    ...
    public SnippetBroadcastReceiver(Context context, SnippetEvent event, String action) {
        mEvent = event;
        mContext = context;
