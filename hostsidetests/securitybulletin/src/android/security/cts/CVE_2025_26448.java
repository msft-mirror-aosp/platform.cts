...
public class CVE_2025_26448 extends NonRootSecurityTestCase {

    @Test
    @AsbSecurityTest(cveBugId = 309407957)
    public void testPocCVE_2025_26448() {
        try {
            final ITestDevice device = getDevice();
            final String abi = device.getProperty("ro.product.cpu.abi");

            // Check for vulnerability
            final String binaryName = "CVE-2025-26448";
            NativePoc.builder()
                    .pocName(binaryName)
