...
public class Bug_305710469 extends NonRootSecurityTestCase {

    private static final String TEST_PKG = "android.security.cts.bug_305710469_test";

    @Test
    @AsbSecurityTest(cveBugId = 305710469)
    public void testBug_305710469() {
        ...
        try {
            ...
            installPackage("bug_305710469_test.apk", "-g");
            installPackage("bug_305710469_provider.apk", "-g --user " + newUser);
