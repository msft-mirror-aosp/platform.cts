...
public class CVE_2024_49749 extends NonRootSecurityTestCase {

    @AsbSecurityTest(cveBugId = 355461643)
    @Test
    public void testPocCVE_2024_49749() {
        try {
            ...
            final List<String> functionNames = List.of("DGifOpen", "DGifSlurp");
