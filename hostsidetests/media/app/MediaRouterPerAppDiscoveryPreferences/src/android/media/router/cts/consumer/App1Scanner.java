...
public class App1Scanner extends BaseScanningActivity {
    public static final String APP1_PREFERRED_FEATURE = "app1_preferred_feature";

    @Override
    public List<String> getPreferredFeatures() {
        return List.of(APP1_PREFERRED_FEATURE);
    }
