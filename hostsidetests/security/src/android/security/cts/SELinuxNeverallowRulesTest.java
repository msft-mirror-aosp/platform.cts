...
public class SELinuxNeverallowRulesTest extends BaseHostJUnit4Test {
    ...
    public static Iterable<Object[]> generateRules() throws Exception {
        ...
        List<Object[]> genRules = new ArrayList<>();
        for (SELinuxNeverallowRule rule : rules) {
            genRules.add(new Object[] {rule.getStableId(), rule});
        }

        return genRules;
    }

    /* Parameters generated by generateRules() and available to testNeverallowRules */
    @Parameter(0)
    public String mId;
