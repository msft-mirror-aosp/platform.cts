...
public class StorageStatsTest extends InstrumentationTestCase {
    ...
    public void testVerifyStatsMultiple() throws Exception {
        ...
        try {
            assertMostlyEquals(CODE_ALL * 2, as.getAppBytes(), 10 * MB_IN_BYTES);
            assertMostlyEquals(CODE_ALL * 1, bs.getAppBytes(), 10 * MB_IN_BYTES);
        } catch (AssertionFailedError e) {
            assertMostlyEquals(CODE_ALL * 4, as.getAppBytes(), 10 * MB_IN_BYTES);
            assertMostlyEquals(CODE_ALL * 2, bs.getAppBytes(), 10 * MB_IN_BYTES);
        }
    }
