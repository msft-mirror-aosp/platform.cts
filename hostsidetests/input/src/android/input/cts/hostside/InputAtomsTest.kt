...
class InputAtomsTest : DeviceTestCase() {
    ...
    fun testInputDeviceUsageAtom() {
        ...
        // The touchscreen is used for exactly five seconds. When verifying the minimum usage
        // duration, leave a 100ms margin of error to account for variances in the injected
        // event's timestamps that are generated by the kernel as the injected events
        // are processed.
