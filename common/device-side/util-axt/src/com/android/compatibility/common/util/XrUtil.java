...
public class XrUtil {
    /**
     * This checks if we support third party magnification on XR devices. By default, Android XR
     * does not support third party magnification.
     */
        ...
        try {
            return context.getResources()
                    .getBoolean(
                            Resources.getSystem()
                                    .getIdentifier(
                                            "config_supportsXRThirdPartyMagnification",
                                            "bool",
                                            "android"));
        } catch (Resources.NotFoundException e) {
            // Third party magnification is opt-in. If
            return false;
        }
    }
}
