...
annotation class EnsureCanAddUser(
    /**
     * The user type we wish to ensure can be added.
     * Values are listed in {@link com.android.bedstead.nene.users.UserType}, or equivalently,
     * the "USER_TYPE_" strings in {@link android.os.UserManager}.
     * E.g. "android.os.usertype.profile.MANAGED".
     *
     * No default; it must be explicitly provided.
     */
    val value: String,
