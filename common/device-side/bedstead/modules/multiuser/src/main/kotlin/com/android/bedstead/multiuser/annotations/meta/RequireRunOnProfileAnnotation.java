...
/**
 * Mark that an annotation is used to indicate that a test should run on a given profile type.
 *
 * <p>The annotation annotated with {@link RequireRunOnProfileAnnotation} must have the same body as
 * {@link RequireRunOnProfile}.
 */
