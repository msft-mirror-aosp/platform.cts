 ...
 * specified by other annotations.
 *
 * <p>Certain users will never be removed: the instrumented user, the current user, the system
 * user, and the main user if it exists (and is non-removable).
 */
@Target(
