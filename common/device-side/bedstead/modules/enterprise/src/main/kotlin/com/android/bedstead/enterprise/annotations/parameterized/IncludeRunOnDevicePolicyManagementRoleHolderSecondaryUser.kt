...
/** Parameterize a test so that it runs on a secondary user of a device with the
...
@EnsureHasNoDpc(onUser = UserType.ANY)
@EnsureHasDevicePolicyManagerRoleHolder(onUser = UserType.SYSTEM_USER, isPrimary = true)
@EnsureHasNoDelegate
annotation class IncludeRunOnDevicePolicyManagementRoleHolderSecondaryUser(
    /**
...
@AutoAnnotation
fun includeRunOnDevicePolicyManagementRoleHolderSecondaryUser(): IncludeRunOnDevicePolicyManagementRoleHolderSecondaryUser {
    return AutoAnnotation_IncludeRunOnDevicePolicyManagementRoleHolderSecondaryUserKt_includeRunOnDevicePolicyManagementRoleHolderSecondaryUser()
}
