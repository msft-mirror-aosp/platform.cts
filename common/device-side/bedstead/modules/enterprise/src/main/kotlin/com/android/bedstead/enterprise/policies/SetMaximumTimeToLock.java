...
/**
 * Policies around setting the maximum time for user activity until the device will lock.
 *
 * <p>This is used by methods such as
 * {@code DevicePolicyManager#setMaximumTimeToLock(ComponentName, long)} and
 * {@code DevicePolicyManager#getMaximumTimeToLock(ComponentName)}.
 */
@EnterprisePolicy(deviceAdmins = {
        @EnterprisePolicy.DeviceAdmin(
                appliesTo = APPLIES_TO_OWN_USER | APPLIES_TO_PARENT,
                usesPolicies = USES_POLICY_FORCE_LOCK)
})
public final class SetMaximumTimeToLock {
}
