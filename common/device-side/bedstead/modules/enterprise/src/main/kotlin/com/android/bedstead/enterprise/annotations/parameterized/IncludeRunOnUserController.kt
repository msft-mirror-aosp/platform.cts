...
annotation class IncludeRunOnUserController(
    /**
...
@AutoAnnotation
fun includeRunOnUserController(): IncludeRunOnUserController {
    return AutoAnnotation_IncludeRunOnUserControllerKt_includeRunOnUserController()
}
