...
@EnsureHasUserController(isPrimary = true, onUser = UserType.INITIAL_USER)
@UsesAnnotationExecutor(UsesAnnotationExecutor.ENTERPRISE)
annotation class IncludeRunOnAdditionalUserWithInitialUserController(
    /**
...
@AutoAnnotation
fun includeRunOnAdditionalUserWithInitialUserController(): IncludeRunOnAdditionalUserWithInitialUserController {
    return AutoAnnotation_IncludeRunOnAdditionalUserWithInitialUserControllerKt_includeRunOnAdditionalUserWithInitialUserController()
}
