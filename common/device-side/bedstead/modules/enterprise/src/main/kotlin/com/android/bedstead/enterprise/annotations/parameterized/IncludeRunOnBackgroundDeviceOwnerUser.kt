...
@RequireRunOnSystemUser(switchedToUser = OptionalBoolean.FALSE)
@EnsureHasDeviceOwner(key = "dpc")
@EnsureHasNoDelegate
annotation class IncludeRunOnBackgroundDeviceOwnerUser(
    /**
...
@AutoAnnotation
fun includeRunOnBackgroundDeviceOwnerUser(): IncludeRunOnBackgroundDeviceOwnerUser {
    return AutoAnnotation_IncludeRunOnBackgroundDeviceOwnerUserKt_includeRunOnBackgroundDeviceOwnerUser()
}
