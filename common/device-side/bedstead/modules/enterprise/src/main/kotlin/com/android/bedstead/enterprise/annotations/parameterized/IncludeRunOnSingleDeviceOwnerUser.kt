...
@EnsureHasNoDelegate
@Ignore
annotation class IncludeRunOnSingleDeviceOwnerUser(
    /**
...
@AutoAnnotation
fun includeRunOnSingleDeviceOwnerUser(): IncludeRunOnSingleDeviceOwnerUser {
    return AutoAnnotation_IncludeRunOnSingleDeviceOwnerUserKt_includeRunOnSingleDeviceOwnerUser()
}
