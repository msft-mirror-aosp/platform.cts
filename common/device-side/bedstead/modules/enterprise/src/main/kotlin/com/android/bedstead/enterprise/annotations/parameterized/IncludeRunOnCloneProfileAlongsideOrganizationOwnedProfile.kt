...
@ParameterizedAnnotation(shadows = [IncludeRunOnCloneProfileAlongsideManagedProfile::class], scope = ENTERPRISE)
@RequireRunOnCloneProfile
@EnsureHasWorkProfile(dpcIsPrimary = true,
        isOrganizationOwned = true,
        dpcKey = "dpc")
@EnsureHasNoDelegate
annotation class IncludeRunOnCloneProfileAlongsideOrganizationOwnedProfile(
    /**
...
@AutoAnnotation
fun includeRunOnCloneProfileAlongsideOrganizationOwnedProfile(): IncludeRunOnCloneProfileAlongsideOrganizationOwnedProfile {
    return AutoAnnotation_IncludeRunOnCloneProfileAlongsideOrganizationOwnedProfileKt_includeRunOnCloneProfileAlongsideOrganizationOwnedProfile()
}
