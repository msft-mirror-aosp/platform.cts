...
@EnsureHasNoProfileOwner(onUser = UserType.INITIAL_USER)
@EnsureHasNoProfileOwner(onUser = UserType.SYSTEM_USER)
@EnsureHasNoDeviceOwner
@EnsureHasDevicePolicyManagerRoleHolder(onUser = UserType.INITIAL_USER, isPrimary = true)
@EnsureHasNoDelegate
annotation class IncludeRunOnDevicePolicyManagementRoleHolderProfile(
    /**
...
@AutoAnnotation
fun includeRunOnDevicePolicyManagementRoleHolderProfile(): IncludeRunOnDevicePolicyManagementRoleHolderProfile {
    return AutoAnnotation_IncludeRunOnDevicePolicyManagementRoleHolderProfileKt_includeRunOnDevicePolicyManagementRoleHolderProfile()
}
