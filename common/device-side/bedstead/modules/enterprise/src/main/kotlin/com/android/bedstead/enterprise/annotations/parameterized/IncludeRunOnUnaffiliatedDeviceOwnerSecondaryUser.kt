...
@EnsureHasDeviceOwner(isPrimary = true, affiliationIds = [], key = "dpc")
@EnsureHasNoDelegate
annotation class IncludeRunOnUnaffiliatedDeviceOwnerSecondaryUser(
    /**
...
@AutoAnnotation
fun includeRunOnUnaffiliatedDeviceOwnerSecondaryUser(): IncludeRunOnUnaffiliatedDeviceOwnerSecondaryUser {
    return AutoAnnotation_IncludeRunOnUnaffiliatedDeviceOwnerSecondaryUserKt_includeRunOnUnaffiliatedDeviceOwnerSecondaryUser()
}
