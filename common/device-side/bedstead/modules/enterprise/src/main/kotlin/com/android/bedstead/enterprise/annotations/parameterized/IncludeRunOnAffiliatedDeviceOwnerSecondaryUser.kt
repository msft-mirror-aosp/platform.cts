...
@ParameterizedAnnotation(
    shadows = [IncludeRunOnUnaffiliatedDeviceOwnerSecondaryUser::class],
    scope = ParameterizedAnnotationScope.ENTERPRISE
)
@RequireRunOnSecondaryUser
@EnsureHasDeviceOwner(isPrimary = true, affiliationIds = ["affiliated"], key = "dpc")
@EnsureHasNoDelegate
annotation class IncludeRunOnAffiliatedDeviceOwnerSecondaryUser(
    /**
...
@AutoAnnotation
fun includeRunOnAffiliatedDeviceOwnerSecondaryUser(): IncludeRunOnAffiliatedDeviceOwnerSecondaryUser {
    return AutoAnnotation_IncludeRunOnAffiliatedDeviceOwnerSecondaryUserKt_includeRunOnAffiliatedDeviceOwnerSecondaryUser()
}
