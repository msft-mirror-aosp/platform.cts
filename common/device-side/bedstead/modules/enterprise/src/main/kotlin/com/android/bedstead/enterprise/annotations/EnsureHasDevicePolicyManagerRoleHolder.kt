 ...
 * the correct state for the method. You can use `DeviceState#dpmRoleHolder()` to interact
...
annotation class EnsureHasDevicePolicyManagerRoleHolder(
     ...
     */
    val priority: Int = ENSURE_HAS_DEVICE_POLICY_MANAGER_ROLE_HOLDER_PRIORITY
) {
    companion object {
        /**
         * We want the isPrimary here to take precedence over any other
         */
        const val ENSURE_HAS_DEVICE_POLICY_MANAGER_ROLE_HOLDER_PRIORITY: Int =
            AnnotationPriorityRunPrecedence.LATE
    }
}

@AutoAnnotation
fun ensureHasDevicePolicyManagerRoleHolder(
    onUser: UserType,
    isPrimary: Boolean
): EnsureHasDevicePolicyManagerRoleHolder {
    return AutoAnnotation_EnsureHasDevicePolicyManagerRoleHolderKt_ensureHasDevicePolicyManagerRoleHolder(
        onUser,
        isPrimary
    )
}
