...
@EnsureHasNoDelegate
annotation class IncludeRunOnSystemDeviceOwnerUser(
    /**
...
@AutoAnnotation
fun includeRunOnSystemDeviceOwnerUser(): IncludeRunOnSystemDeviceOwnerUser {
    return AutoAnnotation_IncludeRunOnSystemDeviceOwnerUserKt_includeRunOnSystemDeviceOwnerUser()
}
