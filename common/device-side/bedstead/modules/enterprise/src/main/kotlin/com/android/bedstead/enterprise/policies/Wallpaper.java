...
/**
 * Policy for setting wallpaper.
 *
 * This is used by methods such as
 * {@code android.app.WallpaperManager#setBitmap(Bitmap)}
 */
@EnterprisePolicy(dpc = {
        APPLIED_BY_DEVICE_OWNER | CANNOT_BE_APPLIED_BY_ROLE_HOLDER | APPLIES_TO_OWN_USER
})
