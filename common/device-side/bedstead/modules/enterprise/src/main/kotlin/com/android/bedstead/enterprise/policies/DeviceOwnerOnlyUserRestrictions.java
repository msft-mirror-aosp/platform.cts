...
/**
 * Policy for applying user restrictions which are only usable by device owners
 *
 * TODO(b/260311936): Remove once individual restrictions have tests
 */
@EnterprisePolicy(dpc = {
        APPLIED_BY_DEVICE_OWNER | APPLIED_BY_PROFILE_OWNER_USER_WITH_NO_DO | APPLIES_TO_OWN_USER})
public final class DeviceOwnerOnlyUserRestrictions {
}
