...
/**
 * Policy for bluetooth contact sharing.
 *
 * This is used by methods such as
 * {@code android.app.admin.DevicePolicyManager#setBluetoothContactSharingDisabled(ComponentName, boolean)},
 * {@code android.app.admin.DevicePolicyManager#getBluetoothContactSharingDisabled(UserHandle)}
 */
@EnterprisePolicy(
        dpc = {APPLIED_BY_PROFILE_OWNER
                | APPLIED_BY_AFFILIATED_PROFILE_OWNER
                | APPLIES_TO_OWN_USER})
public final class DisableBluetoothContactSharing {
}
