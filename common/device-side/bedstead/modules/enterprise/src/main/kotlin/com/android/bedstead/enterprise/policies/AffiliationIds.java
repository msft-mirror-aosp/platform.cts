...
/**
 * Policies for setting affiliation ids.
 *
 * See {@code DevicePolicyManager#setAffiliationIds(ComponentName, Set)} and
 * {@code DevicePolicyManager#getAffiliationIds(ComponentName)}.
 */
@EnterprisePolicy(dpc = {APPLIED_BY_DEVICE_OWNER | APPLIED_BY_PROFILE_OWNER | APPLIES_TO_OWN_USER})
public final class AffiliationIds {
}
