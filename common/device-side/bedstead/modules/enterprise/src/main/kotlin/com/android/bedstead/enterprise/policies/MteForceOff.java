...
/** Policies around forcing Memory Tagging Extension (MTE) off */
@EnterprisePolicy(
        dpc = {APPLIED_BY_DEVICE_OWNER | APPLIES_GLOBALLY | CANNOT_BE_APPLIED_BY_ROLE_HOLDER})
public final class MteForceOff {}
