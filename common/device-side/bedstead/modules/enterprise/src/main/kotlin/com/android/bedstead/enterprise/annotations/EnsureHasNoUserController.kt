...
/**
 * Mark that a test requires that there is no user controller on the specified user.
 *
 * @param onUser Which user type the user controller should be removed on.
...
annotation class EnsureHasNoUserController(
