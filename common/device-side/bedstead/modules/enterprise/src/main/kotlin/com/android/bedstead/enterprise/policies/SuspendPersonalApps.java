...
/**
 * Policy for suspended personal apps.
 *
 * This is used by
 * {@code android.app.admin.DevicePolicyManager#setPersonalAppsSuspended(ComponentName, boolean)}
 */
@EnterprisePolicy(dpc = APPLIED_BY_ORGANIZATION_OWNED_PROFILE_OWNER_PROFILE | APPLIES_TO_PARENT
        | INHERITABLE | CANNOT_BE_APPLIED_BY_ROLE_HOLDER)
public final class SuspendPersonalApps {
}
