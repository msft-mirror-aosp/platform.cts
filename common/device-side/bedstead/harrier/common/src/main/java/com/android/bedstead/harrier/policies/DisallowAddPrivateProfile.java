...
import static com.android.bedstead.nene.permissions.CommonPermissions.MANAGE_DEVICE_POLICY_PROFILES;

import com.android.bedstead.harrier.annotations.enterprise.EnterprisePolicy;

/**
 * Policy related to setting {@code DISALLOW_ADD_PRIVATE_PROFILE}
 */
@EnterprisePolicy(dpc = {
        APPLIED_BY_PARENT_INSTANCE_OF_ORGANIZATIONAL_OWNED_PROFILE_OWNER_PROFILE
                | APPLIES_TO_OWN_USER
}, permissions = @EnterprisePolicy.Permission(
        appliedWith = MANAGE_DEVICE_POLICY_PROFILES,
        appliesTo = APPLIES_TO_OWN_USER))
public final class DisallowAddPrivateProfile {
}
