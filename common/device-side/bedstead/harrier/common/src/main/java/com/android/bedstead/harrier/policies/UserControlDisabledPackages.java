...
import static com.android.bedstead.permissions.CommonPermissions.MANAGE_DEVICE_POLICY_APPS_CONTROL;
...
@EnterprisePolicy(dpc = {
        APPLIED_BY_DEVICE_OWNER | APPLIED_BY_FINANCED_DEVICE_OWNER | APPLIES_GLOBALLY
                | CANNOT_BE_APPLIED_BY_ROLE_HOLDER,
        APPLIED_BY_PROFILE_OWNER | APPLIES_TO_OWN_USER | CANNOT_BE_APPLIED_BY_ROLE_HOLDER
        }, permissions = @EnterprisePolicy.Permission(
                appliedWith = MANAGE_DEVICE_POLICY_APPS_CONTROL, appliesTo = APPLIES_TO_OWN_USER))
