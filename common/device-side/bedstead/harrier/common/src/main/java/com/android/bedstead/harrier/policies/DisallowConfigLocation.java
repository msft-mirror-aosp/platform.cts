...
/**
 * Policy related to setting {@code DISALLOW_CONFIG_LOCATION}
 */
...
})//, permissions = @EnterprisePolicy.Permission(appliedWith = MANAGE_DEVICE_POLICY_LOCATION, appliesTo = APPLIES_TO_OWN_USER))
public final class DisallowConfigLocation {
}
