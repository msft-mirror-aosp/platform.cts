...
/**
 * Policy related to setting {@code DISALLOW_CONFIG_TETHERING}
 */
@EnterprisePolicy(dpc = {
        APPLIED_BY_DEVICE_OWNER | APPLIES_GLOBALLY | CANNOT_BE_APPLIED_BY_ROLE_HOLDER,
        APPLIED_BY_PROFILE_OWNER_USER_WITH_NO_DO | APPLIED_BY_PARENT_INSTANCE_OF_ORGANIZATIONAL_OWNED_PROFILE_OWNER_PROFILE
