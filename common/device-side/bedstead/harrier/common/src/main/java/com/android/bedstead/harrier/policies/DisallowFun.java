...
import static com.android.bedstead.permissions.CommonPermissions.MANAGE_DEVICE_POLICY_FUN;

import com.android.bedstead.harrier.annotations.enterprise.EnterprisePolicy;

/**
 * Policy related to setting {@code DISALLOW_FUN}
 */
@EnterprisePolicy(dpc = {
        ...
        permissions = @EnterprisePolicy.Permission(
                appliedWith = MANAGE_DEVICE_POLICY_FUN, appliesTo = APPLIES_TO_OWN_USER))
public final class DisallowFun {
}
