...
import static com.android.bedstead.permissions.CommonPermissions.MANAGE_DEVICE_POLICY_WINDOWS;

import com.android.bedstead.harrier.annotations.enterprise.EnterprisePolicy;

/**
 * Policy related to setting {@code DISALLOW_CREATE_WINDOWS}
 */
@EnterprisePolicy(dpc = {
        ...
        permissions = @EnterprisePolicy.Permission(
                appliedWith = MANAGE_DEVICE_POLICY_WINDOWS, appliesTo = APPLIES_TO_OWN_USER))
public final class DisallowCreateWindows {
}
