...
/**
 * Policy for setting DISALLOW_CONFIG_BRIGHTNESS and DISALLOW_CONFIG_SCREEN_TIMEOUT.
 */
@EnterprisePolicy(dpc = APPLIED_BY_DEVICE_OWNER
        ...
        permissions = @EnterprisePolicy.Permission(
                appliedWith = MANAGE_DEVICE_POLICY_DISPLAY,
                appliesTo = APPLIES_TO_OWN_USER)
)
public class DisallowScreenConfigRestrictions {
}
