...
/**
 * Policies around Lock Task mode for the system supervision app
 * (https://developer.android.com/work/dpc/dedicated-devices/lock-task-mode).
 *
 * <p>This is used by methods such as {@code DevicePolicyManager#setLockTaskFeatures(ComponentName,
 * int)} and {@code DevicePolicyManager#setLockTaskPackages(ComponentName, String[])}.
 */
@EnterprisePolicy(
        dpc = {
...
public final class LockTaskSupervision {}
