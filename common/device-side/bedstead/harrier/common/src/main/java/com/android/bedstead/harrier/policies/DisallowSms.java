...
import static com.android.bedstead.permissions.CommonPermissions.MANAGE_DEVICE_POLICY_SMS;
...
@EnterprisePolicy(dpc = {
        ...
        permissions = @EnterprisePolicy.Permission(appliedWith = MANAGE_DEVICE_POLICY_SMS,
                appliesTo = APPLIES_TO_OWN_USER))
public final class DisallowSms {
}
