...
import static com.android.bedstead.permissions.CommonPermissions.MANAGE_DEVICE_POLICY_USB_FILE_TRANSFER;

import com.android.bedstead.harrier.annotations.enterprise.EnterprisePolicy;

/**
 * Policy related to setting {@code DISALLOW_USB_FILE_TRANSFER}
 */
@EnterprisePolicy(dpc = {
        ...
        permissions = @EnterprisePolicy.Permission(
                appliedWith = MANAGE_DEVICE_POLICY_USB_FILE_TRANSFER,
