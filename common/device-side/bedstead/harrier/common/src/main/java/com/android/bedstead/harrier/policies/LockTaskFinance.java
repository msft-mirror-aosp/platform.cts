...
import static com.android.bedstead.permissions.CommonPermissions.MANAGE_DEVICE_POLICY_LOCK_TASK;

import com.android.bedstead.harrier.annotations.enterprise.EnterprisePolicy;

/**
 * Policies around Lock Task mode for a financed device
...
@EnterprisePolicy(dpc = {APPLIED_BY_DEVICE_OWNER | APPLIES_TO_OWN_USER
        ...
        APPLIED_BY_AFFILIATED_PROFILE_OWNER | APPLIED_BY_PROFILE_OWNER_USER_WITH_NO_DO
                | APPLIES_TO_OWN_USER | APPLIED_BY_FINANCED_DEVICE_OWNER
                | CANNOT_BE_APPLIED_BY_ROLE_HOLDER},
        permissions = @EnterprisePolicy.Permission(
        appliedWith = MANAGE_DEVICE_POLICY_LOCK_TASK, appliesTo = APPLIES_TO_OWN_USER))
public final class LockTaskFinance {
}
