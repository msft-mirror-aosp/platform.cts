 ...
 * {@code DevicePolicyManager#KEYGUARD_DISABLE_UNREDACTED_NOTIFICATIONS}
 */
@EnterprisePolicy(dpc = {
        APPLIED_BY_DEVICE_OWNER | APPLIED_BY_FINANCED_DEVICE_OWNER | APPLIED_BY_PROFILE_OWNER | APPLIES_TO_OWN_USER | CANNOT_BE_APPLIED_BY_ROLE_HOLDER,
        APPLIED_BY_PARENT_INSTANCE_OF_PROFILE_OWNER_PROFILE // Filtered out so doesn't apply anywhere
...
public final class KeyguardDisableUnredactedNotifications {
}
