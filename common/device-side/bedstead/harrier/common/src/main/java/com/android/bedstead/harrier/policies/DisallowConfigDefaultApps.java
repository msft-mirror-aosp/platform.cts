...
import static com.android.bedstead.permissions.CommonPermissions.MANAGE_DEFAULT_APPLICATIONS;

import com.android.bedstead.harrier.annotations.enterprise.EnterprisePolicy;

/**
 * Policy related to setting {@code DISALLOW_CONFIG_DEFAULT_APPS}
 */
@EnterprisePolicy(dpc = {
        ...
        permissions = @EnterprisePolicy.Permission(appliedWith = MANAGE_DEFAULT_APPLICATIONS,
                appliesTo = APPLIES_TO_OWN_USER))
public final class DisallowConfigDefaultApps {
}
