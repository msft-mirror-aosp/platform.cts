...
/**
 * Mark that a test method should run on a
 * {@link com.android.bedstead.nene.users.UserReference#isVisibleBagroundNonProfileUser()
 * visible background user that is not a profile}.
 */
@Target({ElementType.METHOD, ElementType.ANNOTATION_TYPE, ElementType.TYPE})
@Retention(RetentionPolicy.RUNTIME)
@UsesAnnotationExecutor(UsesAnnotationExecutor.MULTI_USER)
public @interface RequireRunOnVisibleBackgroundNonProfileUser {
