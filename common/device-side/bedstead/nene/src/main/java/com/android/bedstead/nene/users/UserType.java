...
public final class UserType {
    ...
    public static final String CLONE_PROFILE_TYPE_NAME = "android.os.usertype.profile.CLONE";
    public static final String PRIVATE_PROFILE_TYPE_NAME = "android.os.usertype.profile.PRIVATE";
