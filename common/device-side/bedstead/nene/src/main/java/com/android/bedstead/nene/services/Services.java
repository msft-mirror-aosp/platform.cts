...
public final class Services {
    ...
    private static final Map<String, String> sServiceMapping =
            Map.ofEntries(
                    ...
                    // entry(Context.CONTENT_CAPTURE_MANAGER_SERVICE,
                    // "android.view.contentcapture.ContentCaptureManager"),
                    entry(
                            Context.TRANSLATION_MANAGER_SERVICE,
                            "android.view.translation.TranslationManager"),
                    entry(
                            Context.UI_TRANSLATION_SERVICE,
                    ...
                    entry(
                            Context.PERMISSION_CONTROLLER_SERVICE,
                    ...
                    entry(
                            Context.SHARED_CONNECTIVITY_SERVICE,
    ...
    public boolean serviceIsAvailable(Class<?> serviceClass) {
        ...
        if (!sServiceNameMapping.containsKey(service)) {
            throw new NeneException(
                    "Unknown service " + serviceClass + ". Check Nene Services map");
        }
