...
object SecureSettings {
    ...
    /**
     * Put int to secure settings for the given [UserReference].
     *
     *
    ...
    /**
     * Get int from secure settings for the given [UserReference].
     *
     *
     * If the user is not the instrumented user, this will only succeed when running on Android S
     * and above.
    ...
    /**
     * Get int from secure settings for the given [UserReference], or the default value.
     *
     *
     * If the user is not the instrumented user, this will only succeed when running on Android S
     * and above.
    ...
    /**
     * Put String to secure settings for the given [UserReference].
     *
     *
     * If the user is not the instrumented user, this will only succeed when running on Android S
     * and above.
     ...
     *
     *
     * If the value is null, the `defaultValue` will be returned.
     */
    @RequiresApi(Build.VERSION_CODES.S)
    fun getString(contentResolver: ContentResolver, key: String, defaultValue: String): String {
        Versions.requireMinimumVersion(Build.VERSION_CODES.S)
        TestApis.permissions().withPermission(INTERACT_ACROSS_USERS_FULL).use {
    ...
    private fun getStringInner(
            contentResolver: ContentResolver, key: String, defaultValue: String): String {
        val s = getStringInner(contentResolver, key)
        return s ?: defaultValue
    }

    /**
     * Get String from secure settings for the given [UserReference].
     *
     *
     * If the user is not the instrumented user, this will only succeed when running on Android S
     * and above.
    ...
    /**
     * Get String from secure settings for the given [UserReference], or the default value.
     *
     *
     * If the user is not the instrumented user, this will only succeed when running on Android S
     * and above.
     ...
     */
    @SuppressLint("NewApi")
    fun getString(user: UserReference, key: String, defaultValue: String): String {
        return if (user == TestApis.users().instrumented()) {
     ...
     *
     * See [Settings.Secure.resetToDefaults].
     *
     *
