 ...
 * granted access to.
 *
 * <p>This interface is strictly for read-only operations, such as searching for documents ({@link
 * #search}), retrieving documents by ID ({@link #getByDocumentId}), and fetching schemas ({@link
 * #getSchema}). It does not include methods for writing data.
 *
 * <p>All implementations of this interface must be thread safe.
 *
 * @see AppSearchSessionShim
 */
// TODO: b/454623046 - add remaining read apis from GlobalSearchSessionShim when those apis are also
//  supported by EnterpriseGlobalSearchSessionShim
public interface ReadOnlyGlobalSearchSessionShim {
    /**
