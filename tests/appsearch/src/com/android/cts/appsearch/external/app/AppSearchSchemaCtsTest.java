...
public class AppSearchSchemaCtsTest {
    ...
    public void testPropertyConfig_withDeletePropagationType() {
        ...
        assertThat(
                        ((AppSearchSchema.StringPropertyConfig) properties.get(1))
                                .getDeletePropagationType())
                .isEqualTo(AppSearchSchema.StringPropertyConfig.DELETE_PROPAGATION_TYPE_NONE);
    }
    ...
    public void testInvalidStringPropertyConfigsJoinableValueType() {
        ...
        assertThat(e)
                .hasMessageThat()
                .contains("Cannot set JOINABLE_VALUE_TYPE_QUALIFIED_ID with CARDINALITY_REPEATED.");
    }
    ...
    public void testStringPropertyConfig_setJoinableValueType() {
        assertThrows(
                ...
                () ->
                        new StringPropertyConfig.Builder("qualifiedId")
                                .setJoinableValueType(5)
                                .build());
        assertThrows(
                IllegalArgumentException.class,
                () ->
                        new StringPropertyConfig.Builder("qualifiedId")
                                .setJoinableValueType(2)
                                .build());
        assertThrows(
                IllegalArgumentException.class,
                () ->
    ...
    public void testAppSearchSchemaBuilder_setSchemaType() {
        AppSearchSchema schema =
                new AppSearchSchema.Builder("Email").setSchemaType("Email2").build();
