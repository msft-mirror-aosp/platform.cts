...
public class SearchSpecCtsTest {
    ...
    public void testBuildSearchSpec_searchSourceLogTag_exceedLengthLimitation() {
        ...
        IllegalArgumentException e =
                assertThrows(
                        ...
                        () -> new SearchSpec.Builder().setSearchSourceLogTag(longTag));
        assertThat(e)
                .hasMessageThat()
                .contains("The maximum supported tag length is 100. This tag is too long");
    }
        ...
        SearchSpec searchSpec =
                new SearchSpec.Builder()
                        ...
                        .addFilterPropertyPaths(
                                "TypeB",
                                ImmutableList.of(
                                        new PropertyPath("field3"),
                                        new PropertyPath("field4.field5")))
                        .addFilterPropertyPaths(
                                "TypeC", ImmutableList.of(new PropertyPath("field6")))
                        .addFilterProperties("TypeD", ImmutableList.of("field7"))
                        .addFilterPropertyPaths(
                                "TypeE", ImmutableList.of(new PropertyPath("field8")))
    ...
    public void testSetAndGetEnableScorablePropertyRanking() {
        ...
        SearchSpec searchSpecWithScorablePropertyEnabled =
                new SearchSpec.Builder().setScorablePropertyRankingEnabled(true).build();
        assertThat(searchSpecWithScorablePropertyEnabled.isScorablePropertyRankingEnabled())
                .isTrue();
    }
    ...
    public void testSearchSpecBuilder_copyConstructor_embeddingMatchInfo() {
        SearchSpec searchSpec =
                new SearchSpec.Builder().setRetrieveEmbeddingMatchInfos(true).build();
        SearchSpec searchSpecCopy = new SearchSpec.Builder(searchSpec).build();
