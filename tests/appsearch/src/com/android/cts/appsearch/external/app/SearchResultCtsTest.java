...
public class SearchResultCtsTest {
    ...
    public void testJoinedDocument() {
        AppSearchEmail email =
                new AppSearchEmail.Builder("namespace1", "id1").setBody("Hello World.").build();
        AppSearchEmail joinDoc =
                new AppSearchEmail.Builder("namespace1", "id2").setBody("Joined document.").build();
        SearchResult joinSearchResult =
                new SearchResult.Builder("packageName", "databaseName")
                        .setGenericDocument(joinDoc)
                        .build();

        SearchResult withoutJoin =
                new SearchResult.Builder("packageName", "databaseName")
                        .setGenericDocument(email)
                        .build();
        SearchResult withJoin =
                new SearchResult.Builder("packageName", "databaseName")
    ...
    public void testRebuild() {
        AppSearchEmail doc1 =
                new AppSearchEmail.Builder("namespace1", "id1").setBody("Parent document.").build();

        AppSearchEmail joinDoc1 =
                new AppSearchEmail.Builder("namespace1", "id2").setBody("Joined document.").build();
        AppSearchEmail joinDoc2 =
                new AppSearchEmail.Builder("namespace1", "id3").setBody("Joined document.").build();

        SearchResult joinSearchResult1 =
                new SearchResult.Builder("packageName", "databaseName")
                        .setGenericDocument(joinDoc1)
                        .build();
        SearchResult joinSearchResult2 =
                new SearchResult.Builder("packageName", "databaseName")
    ...
    public void testRebuild_parentTypeMap() {
        ...
        SearchResult rebuild =
                searchResultBuilder
                        .setParentTypeMap(Map.of("schema3", List.of("parent5", "parent6")))
                        .build();
        ...
        assertThat(rebuild.getParentTypeMap())
                .containsExactly("schema3", List.of("parent5", "parent6"))
                .inOrder();
    }
}
