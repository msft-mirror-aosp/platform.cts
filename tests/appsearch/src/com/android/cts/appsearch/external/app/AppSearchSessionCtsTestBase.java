...
public abstract class AppSearchSessionCtsTestBase {
    ...
    // Since we cannot call non-public API in the cts test, make a copy of these 3 action types, so
    ...
    public void testSetSchema_maxProperties_nestedSchemas() throws Exception {
        ...
        for (int i = 0; i < maxProperties / 3 + 1; i++) {
            personSchemaBuilder.addProperty(
                    new StringPropertyConfig.Builder("string" + i)
                            .setIndexingType(StringPropertyConfig.INDEXING_TYPE_EXACT_TERMS)
                            .setTokenizerType(StringPropertyConfig.TOKENIZER_TYPE_PLAIN)
                            .build());
        ...
        for (int i = 0; i < maxProperties / 3; i++) {
            addressSchemaBuilder.addProperty(
                    new StringPropertyConfig.Builder("string" + i)
                            .setIndexingType(StringPropertyConfig.INDEXING_TYPE_EXACT_TERMS)
                            .setTokenizerType(StringPropertyConfig.TOKENIZER_TYPE_PLAIN)
                            .build());
    ...
    public void testGetSchema_visibilitySetting_oneSharedSchema() throws Exception {
        ...
        AppSearchSchema noteSchema =
                new AppSearchSchema.Builder("Note")
                        .addProperty(new StringPropertyConfig.Builder("subject").build())
                        .build();
    ...
    public void testSetSchema_publiclyVisible() throws Exception {
        ...
        SetSchemaRequest request =
                new SetSchemaRequest.Builder()
                        ...
                        .setPubliclyVisibleSchema("builtin:Email", pkg)
                        .build();
        ...
        SetSchemaRequest request =
                new SetSchemaRequest.Builder()
                        ...
                        .setPubliclyVisibleSchema(
                                "Email",
                                new PackageIdentifier(mContext.getPackageName(), new byte[32]))
                        .build();
        Exception e =
                assertThrows(
                        UnsupportedOperationException.class,
    ...
    public void testGetSchema_longPropertyIndexingType() throws Exception {
        ...
        AppSearchSchema inSchema =
                new AppSearchSchema.Builder("Test")
                        .addProperty(
                                new LongPropertyConfig.Builder("indexableLong")
                                        .setCardinality(PropertyConfig.CARDINALITY_OPTIONAL)
                                        .setIndexingType(LongPropertyConfig.INDEXING_TYPE_RANGE)
                                        .build())
                        .addProperty(
                                new LongPropertyConfig.Builder("long")
                                        .setCardinality(PropertyConfig.CARDINALITY_OPTIONAL)
    ...
    public void testGetSchema_joinableValueTypeQualifiedIdRepeatedProperty() throws Exception {
        ...
        assumeTrue(
                mDb1.getFeatures()
                        .isFeatureSupported(Features.SCHEMA_JOINABLE_REPEATED_PROPERTIES));
        AppSearchSchema inSchema =
                new AppSearchSchema.Builder("Test")
                        .addProperty(
                                new StringPropertyConfig.Builder("qualifiedId")
    ...
    public void testPutDocuments_takenActionGenericDocuments() throws Exception {
                ...
                new AppSearchSchema.Builder("builtin:ClickAction")
                        ...
                        .addProperty(
                                new StringPropertyConfig.Builder("query")
                                        ...
                                        .build())
                        .addProperty(
                                new StringPropertyConfig.Builder("referencedQualifiedId")
                                        .setCardinality(PropertyConfig.CARDINALITY_OPTIONAL)
                                        .setJoinableValueType(
                                                StringPropertyConfig
                                                        .JOINABLE_VALUE_TYPE_QUALIFIED_ID)
        ...
        AppSearchSchema impressionActionSchema =
                new AppSearchSchema.Builder("builtin:ImpressionAction")
                        .addProperty(
                                new LongPropertyConfig.Builder("actionType")
                                        .setCardinality(PropertyConfig.CARDINALITY_OPTIONAL)
                                        .build())
                        ...
                        .addProperty(
                                new StringPropertyConfig.Builder("referencedQualifiedId")
                                        ...
                                        .build())
                        .build();
        AppSearchSchema dismissActionSchema =
                new AppSearchSchema.Builder("builtin:DismissAction")
                        .addProperty(
                                new LongPropertyConfig.Builder("actionType")
                                        .setCardinality(PropertyConfig.CARDINALITY_OPTIONAL)
                                        .build())
        ...
        mDb1.setSchemaAsync(
                        new SetSchemaRequest.Builder()
                                .addSchemas(
                                        searchActionSchema,
                                        clickActionSchema,
                                        impressionActionSchema,
                                        dismissActionSchema)
                                .build())
                .get();

        // Put search action, click action and impression action generic documents.
        ...
        GenericDocument clickAction =
                new GenericDocument.Builder<>("namespace", "click", "builtin:ClickAction")
                        ...
                        .setPropertyString("query", "body")
                        .setPropertyString("referencedQualifiedId", "pkg$db/ns#refId1")
                        .build();
        GenericDocument impressionAction =
                new GenericDocument.Builder<>("namespace", "impression", "builtin:ImpressionAction")
                        .setCreationTimestampMillis(3000)
                        .setPropertyLong("actionType", ACTION_TYPE_IMPRESSION)
                        .setPropertyString("query", "body")
                        .setPropertyString("referencedQualifiedId", "pkg$db/ns#refId2")
                        .build();
        GenericDocument dismissAction =
                new GenericDocument.Builder<>("namespace", "dismiss", "builtin:DismissAction")
                        .setCreationTimestampMillis(4000)
                        .setPropertyLong("actionType", ACTION_TYPE_DISMISS)
                        .setPropertyString("query", "body")
                        .setPropertyString("referencedQualifiedId", "pkg$db/ns#refId3")
                        .build();
        ...
        assertThat(result.getSuccesses()).containsEntry("impression", null);
        assertThat(result.getSuccesses()).containsEntry("dismiss", null);
        assertThat(result.getFailures()).isEmpty();
    }
    ...
    public void testQueryIndexableLongProperty_numericSearchNotEnabled() throws Exception {
        ...
        SearchResultsShim searchResults =
                mDb1.search(
                        "price < 20",
                        new SearchSpec.Builder().setNumericSearchEnabled(false).build());
                ...
                mDb1.search(
                        ...
                        new SearchSpec.Builder()
                                ...
                                .setPropertyWeights(
                                        ...
                                        ImmutableMap.of(
                                                "from", 0.1, "to", 0.2, "subject", 2.0, "body",
                                                0.4))
                                // this.propertyWeights() returns normalized property weights, in
                                // which each
                                // weight is divided by the maximum weight.
                                // As a result, this expression will evaluates to the list {0.1 /
                                // 2.0, 0.2 / 2.0,
                                // 0.4 / 2.0}, since the matched properties are "from", "to" and
                                // "body", and the
                                // maximum weight provided is 2.0.
                                // Thus, sum(this.propertyWeights()) will be evaluated to 0.05 + 0.1
                                // + 0.2 = 0.35.
    ...
    public void testQuery_advancedRankingWithJoin() throws Exception {
        ...
        GenericDocument viewAction1 =
                new GenericDocument.Builder<>("NS", "id2", "ViewAction")
                        .setScore(1)
        ...
        checkIsBatchResultSuccess(
                mDb1.putAsync(
                        new PutDocumentsRequest.Builder()
                                .addGenericDocuments(inEmail, viewAction1, viewAction2)
                                .build()));
    ...
    @Test
    public void testQueryRankByClickActions_useTakenActionGenericDocument() throws Exception {
        assumeTrue(mDb1.getFeatures().isFeatureSupported(Features.JOIN_SPEC_AND_QUALIFIED_ID));
        ...
        String qualifiedId1 =
                DocumentIdUtil.createQualifiedId(mContext.getPackageName(), DB_NAME_1, inEmail1);
        String qualifiedId2 =
        ...
        GenericDocument clickAction3 =
                new GenericDocument.Builder<>("namespace", "click3", "builtin:ClickAction")
                        ...
                        .setPropertyString("referencedQualifiedId", qualifiedId1)
                        .build();
        GenericDocument impressionAction1 =
                new GenericDocument.Builder<>(
                        ...
                        .setPropertyString("referencedQualifiedId", qualifiedId2)
                        .build();
        GenericDocument dismissAction1 =
    ...
    @Test
    public void testQueryRankByImpressionActions_useTakenActionGenericDocument() throws Exception {
        assumeTrue(mDb1.getFeatures().isFeatureSupported(Features.JOIN_SPEC_AND_QUALIFIED_ID));
        ...
        SearchSpec nestedSearchSpec =
                new SearchSpec.Builder()
                        .setRankingStrategy(SearchSpec.RANKING_STRATEGY_DOCUMENT_SCORE)
                        .setOrder(SearchSpec.ORDER_DESCENDING)
                        .addFilterSchemas("builtin:ImpressionAction")
                        .build();
        ...
        // Search "body" for AppSearchEmail documents, ranking by ImpressionAction signals with
        // query = "body".
        SearchResultsShim searchResults =
                mDb1.search(
                        "body",
        ...
        assertThat(sr).hasSize(2);
        assertThat(sr.get(0).getGenericDocument().getId()).isEqualTo("email2");
        assertThat(sr.get(0).getRankingSignal()).isEqualTo(1.0);
        assertThat(sr.get(1).getGenericDocument().getId()).isEqualTo("email1");
    ...
    public void testQueryRankByDismissActions_useTakenActionGenericDocument() throws Exception {
        ...
        GenericDocument dismissAction1 =
                new GenericDocument.Builder<>("namespace", "dismiss1", "builtin:DismissAction")
                        ...
                        .setPropertyString("referencedQualifiedId", qualifiedId2)
                        .build();
        GenericDocument dismissAction2 =
                new GenericDocument.Builder<>("namespace", "dismiss2", "builtin:DismissAction")
                        ...
                        .setPropertyString("referencedQualifiedId", qualifiedId2)
                        .build();
        GenericDocument dismissAction3 =
                new GenericDocument.Builder<>("namespace", "dismiss3", "builtin:DismissAction")
        ...
        SearchSpec nestedSearchSpec =
                new SearchSpec.Builder()
                        .setRankingStrategy(SearchSpec.RANKING_STRATEGY_DOCUMENT_SCORE)
                        .setOrder(SearchSpec.ORDER_DESCENDING)
                        .addFilterSchemas("builtin:DismissAction")
                        .build();
        ...
        // Search "body" for AppSearchEmail documents, ranking by DismissAction signals with
        // query = "body" via advanced scoring language syntax to assign negative weights.
        SearchResultsShim searchResults =
                mDb1.search(
                        "body",
                        new SearchSpec.Builder()
                                .setRankingStrategy("-len(this.childrenRankingSignals())")
                                .setOrder(SearchSpec.ORDER_DESCENDING)
                                .setJoinSpec(js)
                                .setTermMatch(SearchSpec.TERM_MATCH_EXACT_ONLY)
                                .addFilterSchemas(AppSearchEmail.SCHEMA_TYPE)
        ...
        assertThat(sr).hasSize(2);
        assertThat(sr.get(0).getGenericDocument().getId()).isEqualTo("email1");
        assertThat(sr.get(0).getRankingSignal()).isEqualTo(-0.0);
        assertThat(sr.get(1).getGenericDocument().getId()).isEqualTo("email2");
        assertThat(sr.get(1).getRankingSignal()).isEqualTo(-3.0);
    }
    ...
    public void testQuery_invalidAdvancedRanking() throws Exception {
        ...
        assertThat(exception)
                .hasMessageThat()
                .contains("Math functions must have at least one argument.");
    }
    ...
    public void testQuery_unsupportedAdvancedRanking() throws Exception {
        ...
        UnsupportedOperationException e =
                assertThrows(
                        UnsupportedOperationException.class, () -> mDb1.search("body", searchSpec));
        assertThat(e)
                .hasMessageThat()
                .contains(
        ...
        SearchResultsShim searchResults =
                mDb1.search(
                        ...
                        new SearchSpec.Builder()
                                .setTermMatch(SearchSpec.TERM_MATCH_EXACT_ONLY)
                                .addProjection(
                                        SearchSpec.SCHEMA_TYPE_WILDCARD, Collections.emptyList())
                                .build());
        List<GenericDocument> documents = convertSearchResultsToDocuments(searchResults);
    ...
    public void testQuery_documentIdFilter() throws Exception {
        ...
        // Query for all ids by an empty document id filter.
        SearchResultsShim searchResults =
                mDb1.search(
                        "body",
                        new SearchSpec.Builder()
        ...
        assertThat(documents).containsExactly(email1, email2, email3);

        // Query for all ids by explicitly specifying them.
        searchResults =
                mDb1.search(
                        "body",
                        new SearchSpec.Builder()
                                .setTermMatch(SearchSpec.TERM_MATCH_EXACT_ONLY)
                                .addFilterDocumentIds(ImmutableSet.of("id1", "id2", "id3"))
                                .build());
        documents = convertSearchResultsToDocuments(searchResults);
        assertThat(documents).hasSize(3);
        assertThat(documents).containsExactly(email1, email2, email3);
        ...
        documents = convertSearchResultsToDocuments(searchResults);
        assertThat(documents).hasSize(1);
        assertThat(documents).containsExactly(email1);

        // Query only for id1 and id3
        searchResults =
                mDb1.search(
                        "body",
                        new SearchSpec.Builder()
                                .addFilterDocumentIds(ImmutableSet.of("id1"))
                                .addFilterDocumentIds(ImmutableSet.of("id3"))
                                .setTermMatch(SearchSpec.TERM_MATCH_EXACT_ONLY)
                                .build());
        documents = convertSearchResultsToDocuments(searchResults);
        assertThat(documents).hasSize(2);
        assertThat(documents).containsExactly(email1, email3);
    }

    @Test
    @RequiresFlagsEnabled(Flags.FLAG_ENABLE_SEARCH_SPEC_FILTER_DOCUMENT_IDS)
    public void testQuery_documentIdFilter_withNamespaceFilter() throws Exception {
        assumeTrue(
                mDb1.getFeatures()
                        .isFeatureSupported(Features.SEARCH_SPEC_ADD_FILTER_DOCUMENT_IDS));
        ...
        // Index 3 documents with "id1" in 2 different namespaces
        AppSearchEmail email1 =
        ...
        // Query only for id1 in namespace1
        searchResults =
                mDb1.search(
                        "body",
                        new SearchSpec.Builder()
    ...
    @Test
    @RequiresFlagsEnabled(Flags.FLAG_ENABLE_SEARCH_SPEC_FILTER_DOCUMENT_IDS)
    public void testQuery_documentIdFilter_nonExistentId() throws Exception {
        assumeTrue(
                mDb1.getFeatures()
                        .isFeatureSupported(Features.SEARCH_SPEC_ADD_FILTER_DOCUMENT_IDS));
        ...
        // Query for a non-existent id, which should return nothing.
        SearchResultsShim searchResults =
                mDb1.search(
                        "body",
                        new SearchSpec.Builder()
                                .addFilterDocumentIds(ImmutableSet.of("nonExistId"))
                                .setTermMatch(SearchSpec.TERM_MATCH_EXACT_ONLY)
                                .build());
        List<GenericDocument> documents = convertSearchResultsToDocuments(searchResults);
        assertThat(documents).isEmpty();
    ...
    @Test
    @RequiresFlagsEnabled(Flags.FLAG_ENABLE_SEARCH_SPEC_FILTER_DOCUMENT_IDS)
    public void testQuery_documentIdFilter_notSupported() throws Exception {
        assumeFalse(
                mDb1.getFeatures()
                        .isFeatureSupported(Features.SEARCH_SPEC_ADD_FILTER_DOCUMENT_IDS));
        ...
        SearchResultsShim searchResults =
                mDb1.search(
                        ...
                        new SearchSpec.Builder()
                                .setTermMatch(SearchSpec.TERM_MATCH_EXACT_ONLY)
                                .addFilterProperties(
                                        "NonExistentType", ImmutableList.of("to", "title"))
                                .build());
        List<GenericDocument> documents = convertSearchResultsToDocuments(searchResults);
        ...
        SearchResultsShim searchResults =
                mDb1.search(
                        ...
                        new SearchSpec.Builder()
                                .setTermMatch(SearchSpec.TERM_MATCH_EXACT_ONLY)
                                .addFilterProperties(
                                        AppSearchEmail.SCHEMA_TYPE, Collections.emptyList())
                                .build());
        List<GenericDocument> documents = convertSearchResultsToDocuments(searchResults);
    ...
    public void testSnippet_usingTextMatchInfo() throws Exception {
        ...
        assertThat(matchInfo.getTextMatch().getFullText())
                .isEqualTo(
                        "A commonly used fake word is foo. "
                                + "Another nonsense word that’s used a lot is bar");
        assertThat(matchInfo.getTextMatch().getExactMatchRange())
                .isEqualTo(new SearchResult.MatchRange(/* start= */ 29, /* end= */ 32));
        assertThat(matchInfo.getTextMatch().getExactMatch().toString()).isEqualTo("foo");
        assertThat(matchInfo.getTextMatch().getSnippetRange())
                .isEqualTo(new SearchResult.MatchRange(/* start= */ 26, /* end= */ 33));
        assertThat(matchInfo.getTextMatch().getSnippet().toString()).isEqualTo("is foo.");
        assertThat(matchInfo.getTextMatch().getSubmatchRange())
                .isEqualTo(new SearchResult.MatchRange(/* start= */ 29, /* end= */ 31));
    ...
    public void testEmbeddingSnippet() throws Exception {
        ...
        EmbeddingVector embedding1Vector =
                new EmbeddingVector(new float[] {0.1f, 0.2f, 0.3f, 0.4f, 0.5f}, "my_model_v1");
        EmbeddingVector embedding2Vector0 =
                new EmbeddingVector(new float[] {0.6f, 0.7f, 0.8f}, "my_model_v2");
        EmbeddingVector embedding2Vector1 =
                new EmbeddingVector(new float[] {-0.1f, -0.2f, -0.3f, 0.4f, 0.5f}, "my_model_v1");
        EmbeddingVector embedding2Vector2 =
                new EmbeddingVector(new float[] {-0.1f, -0.2f, -0.3f, 0.4f, 0.7f}, "my_model_v1");
        GenericDocument doc0 =
                new GenericDocument.Builder<>("namespace", "id0", "Email")
                        ...
                        .build();
        checkIsBatchResultSuccess(
                mDb1.putAsync(new PutDocumentsRequest.Builder().addGenericDocuments(doc0).build()));
        ...
        assertThat(matchInfo0.getEmbeddingMatch().getEmbeddingSearchMetricType())
        ...
        assertThat(matchInfo1.getEmbeddingMatch().getEmbeddingSearchMetricType())
                .isEqualTo(SearchSpec.EMBEDDING_SEARCH_METRIC_TYPE_DOT_PRODUCT);
        // Verify that the property path returns the right embedding vector
        ...
        assertThat(matchInfo2.getEmbeddingMatch().getEmbeddingSearchMetricType())
                .isEqualTo(SearchSpec.EMBEDDING_SEARCH_METRIC_TYPE_DOT_PRODUCT);
        // Verify that the property path returns the right embedding vector
    ...
    public void testHybridSnippet() throws Exception {
        ...
        // Verify SearchResultsShim
        SearchResultsShim searchResults =
                mDb1.search("fo OR semanticSearch(getEmbeddingParameter(0), -1, 1)", searchSpec);
        List<SearchResult> results = retrieveAllSearchResults(searchResults);
        assertThat(results).hasSize(1);
        assertThat(results.get(0).getGenericDocument()).isEqualTo(doc0);
        ...
        assertThat(matchInfo0.getTextMatch().getSnippetRange())
                .isEqualTo(new SearchResult.MatchRange(/* start= */ 26, /* end= */ 33));
        assertThat(matchInfo0.getTextMatch().getSnippet().toString()).isEqualTo("is foo.");
        assertThat(matchInfo0.getTextMatch().getSubmatchRange())
                .isEqualTo(new SearchResult.MatchRange(/* start= */ 29, /* end= */ 31));
        ...
        assertThat(matchInfo3.getEmbeddingMatch().getEmbeddingSearchMetricType())
                .isEqualTo(SearchSpec.EMBEDDING_SEARCH_METRIC_TYPE_DOT_PRODUCT);
        // Verify that the property path returns the right embedding vector
    ...
    public void testRemove_emptyIds_hasNoEffect() throws Exception {
        ...
        // Delete the document
        checkIsBatchResultSuccess(
                mDb1.removeAsync(new RemoveByDocumentIdRequest.Builder("namespace").build()));
    ...
    public void testRfc822() throws Exception {
        ...
        GenericDocument email =
                new GenericDocument.Builder<>("NS", "alex1", "Email")
        ...
        SearchResultsShim sr = mDb1.search("com", new SearchSpec.Builder().build());
        ...
        AppSearchSchema plainEmailSchema =
                new AppSearchSchema.Builder("Email")
                        .addProperty(
                                new StringPropertyConfig.Builder("address")
                                        .setCardinality(PropertyConfig.CARDINALITY_OPTIONAL)
        ...
        mDb1.setSchemaAsync(new SetSchemaRequest.Builder().addSchemas(plainEmailSchema).build())
                .get();
    ...
    public void testQuery_verbatimSearchWithoutEnablingFeatureFails() throws Exception {
        ...
        SearchResultsShim searchResults =
                mDb1.search(
                        "\"Hello, world!\"",
                        new SearchSpec.Builder().setVerbatimSearchEnabled(false).build());
        ExecutionException executionException =
                assertThrows(
                        ExecutionException.class, () -> searchResults.getNextPageAsync().get());
        assertThat(executionException).hasCauseThat().isInstanceOf(AppSearchException.class);
    ...
    public void testQuery_listFilterQueryWithEnablingFeatureSucceeds() throws Exception {
        ...
        GenericDocument email =
                new GenericDocument.Builder<>("namespace1", "id1", "Schema")
        ...
        SearchResultsShim searchResults =
                mDb1.search("search(\"hello\", createList(\"prop\"))", searchSpec);
        List<SearchResult> page = searchResults.getNextPageAsync().get();
        assertThat(page).hasSize(1);
        assertThat(page.get(0).getGenericDocument().getId()).isEqualTo("id1");
    ...
    public void testQuery_listFilterQueryWithoutEnablingFeatureFails() throws Exception {
        ...
        SearchSpec searchSpec =
                new SearchSpec.Builder().setListFilterQueryLanguageEnabled(false).build();
        SearchResultsShim searchResults =
                mDb1.search("search(\"hello\", createList(\"prop\"))", searchSpec);
        ExecutionException executionException =
                assertThrows(
        ...
        SearchResultsShim searchResults2 = mDb1.search("wor*", searchSpec);
        executionException =
                assertThrows(
                        ExecutionException.class, () -> searchResults2.getNextPageAsync().get());
        assertThat(executionException).hasCauseThat().isInstanceOf(AppSearchException.class);
        exception = (AppSearchException) executionException.getCause();
        assertThat(exception.getResultCode()).isEqualTo(RESULT_INVALID_ARGUMENT);
        assertThat(exception).hasMessageThat().contains("Attempted use of unenabled feature");
        ...
        SearchResultsShim searchResults3 = mDb1.search("NOT (foo OR otherProp:hello)", searchSpec);
        executionException =
                assertThrows(
    ...
    public void testQuery_hasPropertyFunction() throws Exception {
        ...
        GenericDocument doc1 =
                new GenericDocument.Builder<>("namespace", "id1", "Schema")
                        .setPropertyString("prop1", "Hello, world!")
                        .build();
        GenericDocument doc2 =
                new GenericDocument.Builder<>("namespace", "id2", "Schema")
                        .setPropertyString("prop2", "Hello, world!")
                        .build();
        GenericDocument doc3 =
                new GenericDocument.Builder<>("namespace", "id3", "Schema")
                        .setPropertyString("prop1", "Hello, world!")
                        .setPropertyString("prop2", "Hello, world!")
                        .build();
        mDb1.putAsync(
        ...
        SearchSpec searchSpec =
                new SearchSpec.Builder()
                        ...
                        .setTermMatch(SearchSpec.TERM_MATCH_EXACT_ONLY)
                        .build();
        SearchResultsShim searchResults = mDb1.search("hasProperty(\"prop1\")", searchSpec);
        List<SearchResult> page = searchResults.getNextPageAsync().get();
        ...
        searchResults =
                mDb1.search("hasProperty(\"prop1\") AND hasProperty(\"prop2\")", searchSpec);
        page = searchResults.getNextPageAsync().get();
        assertThat(page).hasSize(1);
        assertThat(page.get(0).getGenericDocument().getId()).isEqualTo("id3");
    }
    ...
    public void testQuery_hasPropertyFunctionWithoutEnablingFeatureFails() throws Exception {
        ...
        SearchSpec searchSpec =
                new SearchSpec.Builder()
                        ...
                        .setListFilterHasPropertyFunctionEnabled(true)
                        .build();
        SearchResultsShim searchResults = mDb1.search("hasProperty(\"prop\")", searchSpec);
        ExecutionException executionException =
                assertThrows(
                        ExecutionException.class, () -> searchResults.getNextPageAsync().get());
        assertThat(executionException).hasCauseThat().isInstanceOf(AppSearchException.class);
        ...
        searchSpec =
                new SearchSpec.Builder()
                        ...
                        .build();
        SearchResultsShim searchResults2 = mDb1.search("hasProperty(\"prop\")", searchSpec);
        executionException =
                assertThrows(
                        ExecutionException.class, () -> searchResults2.getNextPageAsync().get());
        assertThat(executionException).hasCauseThat().isInstanceOf(AppSearchException.class);
    ...
    public void testQuery_matchScoreExpression() throws Exception {
        ...
        assumeTrue(
                mDb1.getFeatures()
                        .isFeatureSupported(Features.LIST_FILTER_MATCH_SCORE_EXPRESSION_FUNCTION));
        AppSearchSchema schema =
                new AppSearchSchema.Builder("Schema")
                        .addProperty(
                                new StringPropertyConfig.Builder("prop")
        ...
        // Put documents with document scores 3, 4, and 5.
        GenericDocument doc1 =
                new GenericDocument.Builder<>("namespace", "id1", "Schema")
                        .setPropertyString("prop", "Hello, world!")
                        .setScore(3)
        ...
        // Get documents of scores in [3, 4], which should return doc1 and doc2.
        SearchSpec searchSpec =
                new SearchSpec.Builder()
                        .setListFilterQueryLanguageEnabled(true)
                        ...
                        .build();
        SearchResultsShim searchResults =
                mDb1.search("matchScoreExpression(\"this.documentScore()\", 3, 4)", searchSpec);
        List<SearchResult> page = searchResults.getNextPageAsync().get();
        assertThat(page).hasSize(2);
        assertThat(page.get(0).getGenericDocument().getId()).isEqualTo("id2");
        assertThat(page.get(1).getGenericDocument().getId()).isEqualTo("id1");

        // Get documents of scores in [3, 5], which should return all documents.
        searchResults =
                mDb1.search("matchScoreExpression(\"this.documentScore()\", 3, 5)", searchSpec);
        page = searchResults.getNextPageAsync().get();
        assertThat(page).hasSize(3);
        assertThat(page.get(0).getGenericDocument().getId()).isEqualTo("id3");
        assertThat(page.get(1).getGenericDocument().getId()).isEqualTo("id2");
        assertThat(page.get(2).getGenericDocument().getId()).isEqualTo("id1");
    }
    ...
    public void testQuery_listFilterQueryMatchScoreExpressionFunction_notSupported()
        ...
        SearchSpec.Builder builder = new SearchSpec.Builder();
        SearchSpec searchSpec =
                builder.setListFilterMatchScoreExpressionFunctionEnabled(true).build();
    ...
    public void testQuery_matchScoreExpressionFunctionWithoutEnablingFeatureFails()
        ...
        // Enable LIST_FILTER_MATCH_SCORE_EXPRESSION_FUNCTION but disable
        // LIST_FILTER_QUERY_LANGUAGE in the SearchSpec.
        SearchSpec searchSpec =
                new SearchSpec.Builder()
                        .setListFilterQueryLanguageEnabled(false)
                        .setListFilterMatchScoreExpressionFunctionEnabled(true)
        ...
        // Disable LIST_FILTER_MATCH_SCORE_EXPRESSION_FUNCTION in the SearchSpec.
        searchSpec =
                new SearchSpec.Builder()
                        .setListFilterQueryLanguageEnabled(true)
                        .setListFilterMatchScoreExpressionFunctionEnabled(false)
                        .build();
        SearchResultsShim searchResults2 =
                mDb1.search("matchScoreExpression(\"this.documentScore()\", 3, 4)", searchSpec);
        executionException =
                assertThrows(
                        ExecutionException.class, () -> searchResults2.getNextPageAsync().get());
        ...
        assertThat(exception.getResultCode()).isEqualTo(RESULT_INVALID_ARGUMENT);
        assertThat(exception).hasMessageThat().contains("Attempted use of unenabled feature");
        assertThat(exception).hasMessageThat().contains("MATCH_SCORE_EXPRESSION");
    }
    ...
    public void testQuery_propertyWeights() throws Exception {
        ...
        SearchSpec searchSpecWithoutWeights =
                new SearchSpec.Builder()
                        .setTermMatch(SearchSpec.TERM_MATCH_EXACT_ONLY)
                        .setRankingStrategy(SearchSpec.RANKING_STRATEGY_RELEVANCE_SCORE)
                        .setOrder(SearchSpec.ORDER_DESCENDING)
        ...
        SearchResultsShim searchResultsWithoutWeights =
                mDb1.search("foo", searchSpecWithoutWeights);
    ...
    public void testQuery_propertyWeightsNestedProperties() throws Exception {
        ...
        AppSearchSchema schema =
                new AppSearchSchema.Builder("TypeA")
                        .addProperty(
                                new AppSearchSchema.DocumentPropertyConfig.Builder(
                                                "nestedEmail", AppSearchEmail.SCHEMA_TYPE)
                                        .setShouldIndexNestedProperties(true)
                                        .build())
                        .build();
        mDb1.setSchemaAsync(
                        new SetSchemaRequest.Builder()
                                .addSchemas(AppSearchEmail.SCHEMA, schema)
                                .build())
                .get();
        ...
        AppSearchEmail nestedEmail1 =
                new AppSearchEmail.Builder("namespace", "id1")
                        ...
                        .build();
        GenericDocument doc1 =
                new GenericDocument.Builder<>("namespace", "id1", "TypeA")
                        .setPropertyDocument("nestedEmail", nestedEmail1)
                        .build();
        AppSearchEmail nestedEmail2 =
                new AppSearchEmail.Builder("namespace", "id2")
                        ...
                        .build();
        GenericDocument doc2 =
                new GenericDocument.Builder<>("namespace", "id2", "TypeA")
                        .setPropertyDocument("nestedEmail", nestedEmail2)
                        .build();
        checkIsBatchResultSuccess(
                mDb1.putAsync(
    ...
    public void testQuery_propertyWeightsDefaults() throws Exception {
        ...
        SearchResultsShim searchResults =
                mDb1.search(
                        ...
                        new SearchSpec.Builder()
                                ...
                                .build());
        List<SearchResult> resultsWithoutPropertyWeights = retrieveAllSearchResults(searchResults);
        ...
        searchResults =
                mDb1.search(
                        ...
                        new SearchSpec.Builder()
                                ...
                                .setPropertyWeights(
                                        AppSearchEmail.SCHEMA_TYPE,
                                        ImmutableMap.of("subject", 1.0, "body", 1.0))
                                .build());
        ...
        assertThat(resultsWithoutPropertyWeights.get(0).getRankingSignal())
                .isEqualTo(expectedResults.get(0).getRankingSignal());
        assertThat(resultsWithoutPropertyWeights.get(1).getRankingSignal())
                .isEqualTo(expectedResults.get(1).getRankingSignal());
    }
    ...
    public void testQuery_propertyWeightsIgnoresInvalidPropertyPaths() throws Exception {
        ...
        SearchResultsShim searchResults =
                mDb1.search(
                        ...
                        new SearchSpec.Builder()
                                ...
                                .setOrder(SearchSpec.ORDER_DESCENDING)
                                .setPropertyWeights(
                                        AppSearchEmail.SCHEMA_TYPE, ImmutableMap.of("subject", 2.0))
                                .build());
        List<SearchResult> results = retrieveAllSearchResults(searchResults);
        ...
        searchResults =
                mDb1.search(
                        ...
                        new SearchSpec.Builder()
                                ...
                                .setPropertyWeights(
                                        AppSearchEmail.SCHEMA_TYPE,
                                        ImmutableMap.of("subject", 2.0, "invalid", 3.0))
                                .build());
        ...
        // weight.
        assertThat(results.get(0).getRankingSignal()).isGreaterThan(0);
        assertThat(resultsWithInvalidPath.get(0).getRankingSignal())
                .isEqualTo(results.get(0).getRankingSignal());
    ...
    public void testQueryWithJoin_typePropertyFiltersOnNestedSpec() throws Exception {
                ...
                new AppSearchSchema.Builder("ViewAction")
                        ...
                        .addProperty(
                                new StringPropertyConfig.Builder("note")
                                        ...
                                        .build())
                        .addProperty(
                                new StringPropertyConfig.Builder("viewType")
                                        .setCardinality(PropertyConfig.CARDINALITY_OPTIONAL)
                                        .setIndexingType(
                                                StringPropertyConfig.INDEXING_TYPE_EXACT_TERMS)
                                        .setTokenizerType(StringPropertyConfig.TOKENIZER_TYPE_PLAIN)
        ...
        SearchSpec nestedSearchSpec =
                new SearchSpec.Builder()
                        ...
                        .addFilterProperties(
                                AppSearchEmail.SCHEMA_TYPE, ImmutableList.of("subject"))
                        .build();
        ...
        SearchResultsShim searchResults =
                mDb1.search(
                        ...
                        new SearchSpec.Builder()
                                ...
                                .setTermMatch(SearchSpec.TERM_MATCH_EXACT_ONLY)
                                .addFilterProperties(
                                        AppSearchEmail.SCHEMA_TYPE, ImmutableList.of("body"))
                                .addFilterProperties("ViewAction", ImmutableList.of("viewType"))
                                .build());
    ...
    public void testSearchSuggestion() throws Exception {
        ...
        checkIsBatchResultSuccess(
                mDb1.putAsync(
                        new PutDocumentsRequest.Builder()
                                .addGenericDocuments(doc1, doc2, doc3, doc4)
                                .build()));
    ...
    public void testSearchSuggestion_documentIdFilter() throws Exception {
        ...
        GenericDocument doc1 =
                new GenericDocument.Builder<>("namespace1", "id1", "Type")
                        ...
                        .build();
        GenericDocument doc2 =
                new GenericDocument.Builder<>("namespace1", "id2", "Type")
                        .setPropertyString("body", "termtwo")
                        .build();
        GenericDocument doc3 =
                new GenericDocument.Builder<>("namespace2", "id3", "Type")
                        .setPropertyString("body", "termthree")
                        .build();
        GenericDocument doc4 =
                new GenericDocument.Builder<>("namespace2", "id4", "Type")
    ...
    public void testSearchSuggestion_schemaFilter() throws Exception {
                ...
                new AppSearchSchema.Builder("Type2")
                        .addProperty(
                                new StringPropertyConfig.Builder("body")
                                        ...
                                        .build())
                        .build();
        AppSearchSchema schemaType3 =
                new AppSearchSchema.Builder("Type3")
                        .addProperty(
                                new StringPropertyConfig.Builder("body")
                                        .setCardinality(PropertyConfig.CARDINALITY_OPTIONAL)
                                        .setTokenizerType(StringPropertyConfig.TOKENIZER_TYPE_PLAIN)
        ...
        mDb1.setSchemaAsync(
                        new SetSchemaRequest.Builder()
                                .addSchemas(schemaType1, schemaType2, schemaType3)
                                .build())
                .get();
        ...
        GenericDocument doc2 =
                new GenericDocument.Builder<>("namespace", "id2", "Type2")
                        ...
                        .build();
        GenericDocument doc3 =
                new GenericDocument.Builder<>("namespace", "id3", "Type3")
                        .setPropertyString("body", "fool")
                        .build();
    ...
    public void testSearchSuggestion_removeDocument() throws Exception {
        ...
        // Index documents
        GenericDocument docTwo =
                new GenericDocument.Builder<>("namespace", "idTwo", "Type")
                        .setPropertyString("body", "two")
                        .build();
        GenericDocument docThree =
                new GenericDocument.Builder<>("namespace", "idThree", "Type")
                        .setPropertyString("body", "three")
                        .build();
        GenericDocument docTart =
                new GenericDocument.Builder<>("namespace", "idTart", "Type")
        ...
        checkIsBatchResultSuccess(
                mDb1.putAsync(
                        new PutDocumentsRequest.Builder()
                                .addGenericDocuments(docTwo, docThree, docTart)
                                .build()));
    ...
    public void testSearchSuggestion_replacementDocument() throws Exception {
        ...
        GenericDocument replaceDoc =
                new GenericDocument.Builder<>("namespace", "id", "Type")
                        .setPropertyString("body", "twist three")
                        .build();
        checkIsBatchResultSuccess(
                mDb1.putAsync(
                        new PutDocumentsRequest.Builder().addGenericDocuments(replaceDoc).build()));
    ...
    public void testSearchSuggestion_multipleTerms() throws Exception {
        ...
        SearchSuggestionResult barCatOrFool =
                new SearchSuggestionResult.Builder()
                        .setSuggestedResult("(bar cat) OR fool")
                        .build();
    ...
    public void testSearchSuggestion_PropertyRestriction() throws Exception {
        ...
        GenericDocument doc2 =
                new GenericDocument.Builder<>("namespace", "id2", "Type")
                        ...
                        .build();
        GenericDocument doc3 =
                new GenericDocument.Builder<>("namespace", "ide", "Type")
        ...
        for (AppSearchSchema schema : actual) {
            ...
            for (PropertyConfig property : schema.getProperties()) {
                if (property.getName().equals("worksFor")) {
                    assertThat(((DocumentPropertyConfig) property).getIndexableNestedProperties())
                            .isEmpty();
                }
            }
        }
    ...
    public void testEmbeddingSearch_hybrid() throws Exception {
        ...
        SearchSpec searchSpec =
                new SearchSpec.Builder()
                        ...
                        .build();
        SearchResultsShim searchResults =
                mDb1.search("foo OR semanticSearch(getEmbeddingParameter(0), -10, -1)", searchSpec);
        List<SearchResult> results = retrieveAllSearchResults(searchResults);
        assertThat(results).hasSize(2);
        assertThat(results.get(0).getGenericDocument()).isEqualTo(doc0);
    ...
    public void testSearchSpecStrings_simple() throws Exception {
        ...
        assumeTrue(
                mDb1.getFeatures()
                        .isFeatureSupported(Features.SEARCH_SPEC_SEARCH_STRING_PARAMETERS));
        ...
        SearchSpec searchSpec =
                new SearchSpec.Builder()
                        ...
                        .build();
        SearchResultsShim searchResults = mDb1.search("getSearchStringParameter(0)", searchSpec);
    ...
    public void testSuggestionSearchSpecStringParameters_simple() throws Exception {
        ...
        SearchSuggestionSpec spec =
                new SearchSuggestionSpec.Builder(/* maximumResultCount= */ 1)
                        .addSearchStringParameters("foo")
                        .build();
        List<SearchSuggestionResult> suggestions =
    ...
    public void testSearchSuggestionSpecStringParameters_notSupported() throws Exception {
        ...
        UnsupportedOperationException exception =
                assertThrows(
                        UnsupportedOperationException.class,
                        () ->
                                mDb1.searchSuggestionAsync("getSearchStringParameter(0) b", spec)
                                        .get());
        assertThat(exception)
                .hasMessageThat()
                .contains(
    ...
    public void testInformationalRankingExpressions() throws Exception {
        ...
        SearchSpec searchSpec =
                new SearchSpec.Builder()
                        ...
                        .setListFilterQueryLanguageEnabled(true)
                        .build();
        SearchResultsShim searchResults = mDb1.search("", searchSpec);
        List<SearchResult> results = retrieveAllSearchResults(searchResults);
        assertThat(results).hasSize(2);
    ...
    public void testInformationalRankingExpressions_embeddingExpression() throws Exception {
        ...
        SearchSpec searchSpec =
                new SearchSpec.Builder()
                        ...
                        .build();
        SearchResultsShim searchResults =
                mDb1.search("semanticSearch(getEmbeddingParameter(0))", searchSpec);
        List<SearchResult> results = retrieveAllSearchResults(searchResults);
        assertThat(results).hasSize(2);
        // doc0:
        assertThat(results.get(0).getGenericDocument()).isEqualTo(doc0);
    ...
    public void testEmbeddingQuantization() throws Exception {
        assumeTrue(
                mDb1.getFeatures().isFeatureSupported(Features.SCHEMA_EMBEDDING_PROPERTY_CONFIG));
        assumeTrue(mDb1.getFeatures().isFeatureSupported(Features.SCHEMA_EMBEDDING_QUANTIZATION));
        ...
        GenericDocument doc =
                new GenericDocument.Builder<>("namespace", "id", "Email")
                        ...
                        .setPropertyEmbedding(
                                "embedding",
                                new EmbeddingVector(new float[] {0, 1.45f, 255}, "my_model"))
                        .build();
        checkIsBatchResultSuccess(
                mDb1.putAsync(new PutDocumentsRequest.Builder().addGenericDocuments(doc).build()));
        ...
        SearchSpec searchSpec =
                new SearchSpec.Builder()
                        ...
                        .addEmbeddingParameters(
                                new EmbeddingVector(new float[] {1, 1, 1}, "my_model"))
                        .setRankingStrategy(
                                "sum(this.matchedSemanticScores(getEmbeddingParameter(0)))")
                        .setListFilterQueryLanguageEnabled(true)
                        .build();
        SearchResultsShim searchResults =
                mDb1.search("semanticSearch(getEmbeddingParameter(0), -1000, 1000)", searchSpec);
        List<SearchResult> results = retrieveAllSearchResults(searchResults);
        assertThat(results).hasSize(1);
    ...
    public void testEmbeddingQuantization_notSupported() throws Exception {
        ...
        assumeTrue(
                mDb1.getFeatures().isFeatureSupported(Features.SCHEMA_EMBEDDING_PROPERTY_CONFIG));
        assumeFalse(mDb1.getFeatures().isFeatureSupported(Features.SCHEMA_EMBEDDING_QUANTIZATION));
    ...
    public void testRankingFunction_maxMinOrDefault() throws Exception {
        ...
        GenericDocument doc0 =
                new GenericDocument.Builder<>("namespace", "id0", "Email")
                        ...
                        .setPropertyEmbedding(
                                "embedding",
                                new EmbeddingVector(new float[] {0.6f, 0.7f, 0.8f}, "my_model"))
                        .build();
        GenericDocument doc1 =
                new GenericDocument.Builder<>("namespace", "id1", "Email")
                        .setPropertyString("body", "bar")
                        ...
                        .setPropertyEmbedding(
                                "embedding",
                                new EmbeddingVector(new float[] {0.6f, 0.7f, -0.8f}, "my_model"),
                                new EmbeddingVector(new float[] {0.2f, 0.1f, -1.2f}, "my_model"))
                        .build();
        checkIsBatchResultSuccess(
                mDb1.putAsync(
                        new PutDocumentsRequest.Builder().addGenericDocuments(doc0, doc1).build()));
        ...
        // - document 0: -0.5
        // - document 1: -2.1, -1.5
        EmbeddingVector searchEmbedding = new EmbeddingVector(new float[] {-1, -1, 1}, "my_model");
    ...
    @Test
    public void testRankingFunction_maxMinOrDefault_notSupported() throws Exception {
        assumeTrue(
                mDb1.getFeatures()
                        .isFeatureSupported(Features.SEARCH_SPEC_ADVANCED_RANKING_EXPRESSION));
        assumeFalse(
        ...
        SearchResultsShim searchResults1 =
                mDb1.search(
                        "foo",
                        new SearchSpec.Builder().setRankingStrategy("maxOrDefault()").build());
        ExecutionException executionException =
                assertThrows(
                        ExecutionException.class, () -> searchResults1.getNextPageAsync().get());
        assertThat(executionException).hasCauseThat().isInstanceOf(AppSearchException.class);
        AppSearchException exception = (AppSearchException) executionException.getCause();
        assertThat(exception.getResultCode()).isEqualTo(RESULT_INVALID_ARGUMENT);
        ...
        SearchResultsShim searchResults2 =
                mDb1.search(
                        "foo",
                        new SearchSpec.Builder().setRankingStrategy("minOrDefault()").build());
        executionException =
                assertThrows(
                        ExecutionException.class, () -> searchResults2.getNextPageAsync().get());
        assertThat(executionException).hasCauseThat().isInstanceOf(AppSearchException.class);
    ...
    public void testRankingFunction_filterByRange() throws Exception {
        ...
        assumeTrue(
                mDb1.getFeatures()
                        .isFeatureSupported(Features.SEARCH_SPEC_RANKING_FUNCTION_FILTER_BY_RANGE));
        ...
        GenericDocument doc =
                new GenericDocument.Builder<>("namespace", "id", "Email")
                        ...
                        .setPropertyEmbedding(
                                ...
                                new EmbeddingVector(new float[] {0.6f, 0.7f, -0.8f}, "my_model"),
                                new EmbeddingVector(new float[] {0.2f, 0.1f, -1.2f}, "my_model"),
                                new EmbeddingVector(new float[] {0.f, 0.f, 0.1f}, "my_model"))
                        .build();
        checkIsBatchResultSuccess(
                mDb1.putAsync(new PutDocumentsRequest.Builder().addGenericDocuments(doc).build()));
    ...
    @Test
    public void testRankingFunction_filterByRange_notSupported() throws Exception {
        assumeTrue(
                mDb1.getFeatures()
                        .isFeatureSupported(Features.SEARCH_SPEC_ADVANCED_RANKING_EXPRESSION));
        assumeFalse(
        ...
        SearchResultsShim searchResults1 =
                mDb1.search(
                        "foo",
                        new SearchSpec.Builder().setRankingStrategy("filterByRange()").build());
        ExecutionException executionException =
                assertThrows(
                        ExecutionException.class, () -> searchResults1.getNextPageAsync().get());
        assertThat(executionException).hasCauseThat().isInstanceOf(AppSearchException.class);
    ...
    public void testRankWithScorableProperty_getScorablePropertyFunction_notSupported()
        ...
        assumeTrue(
                mDb1.getFeatures()
                        .isFeatureSupported(Features.SEARCH_SPEC_ADVANCED_RANKING_EXPRESSION));
        assumeFalse(
                mDb1.getFeatures().isFeatureSupported(Features.SCHEMA_SCORABLE_PROPERTY_CONFIG));
    ...
    public void testRankWithScorableProperty_setScoringEnabledInSchema_notSupported()
        ...
        AppSearchSchema schema =
                new AppSearchSchema.Builder("Gmail")
                        .addProperty(
                                new BooleanPropertyConfig.Builder("important")
                                        .setCardinality(PropertyConfig.CARDINALITY_OPTIONAL)
    ...
    @Test
    @RequiresFlagsEnabled(Flags.FLAG_ENABLE_SCORABLE_PROPERTY)
    public void testRankWithScorableProperty_simple() throws Exception {
        assumeTrue(mDb1.getFeatures().isFeatureSupported(Features.SCHEMA_SCORABLE_PROPERTY_CONFIG));
        AppSearchSchema schema =
                new AppSearchSchema.Builder("Gmail")
                        .addProperty(
                                new StringPropertyConfig.Builder("subject")
        ...
        GenericDocument doc1 =
                new GenericDocument.Builder<>("namespace", "id1", "Gmail")
                        .setPropertyString("subject", "bar")
                        .setPropertyBoolean("important", true)
                        .setScore(1)
                        .build();
        int rankingScoreOfDoc1 = 2;
        GenericDocument doc2 =
                new GenericDocument.Builder<>("namespace", "id2", "Gmail")
                        .setPropertyString("subject", "bar 2")
                        .setPropertyBoolean("important", true)
                        .setScore(2)
                        .build();
        int rankingScoreOfDoc2 = 3;
        checkIsBatchResultSuccess(
                mDb1.putAsync(
                        new PutDocumentsRequest.Builder().addGenericDocuments(doc1, doc2).build()));
        ...
        assertThat(results.get(0).getRankingSignal()).isWithin(0.00001).of(rankingScoreOfDoc2);
        assertThat(results.get(1).getGenericDocument()).isEqualTo(doc1);
        assertThat(results.get(1).getRankingSignal()).isWithin(0.00001).of(rankingScoreOfDoc1);
    }

    @Test
    @RequiresFlagsEnabled(Flags.FLAG_ENABLE_SCORABLE_PROPERTY)
    public void testRankWithScorableProperty_withNestedSchema() throws Exception {
        assumeTrue(mDb1.getFeatures().isFeatureSupported(Features.SCHEMA_SCORABLE_PROPERTY_CONFIG));
        AppSearchSchema personSchema =
                new AppSearchSchema.Builder("Person")
                        .addProperty(
                                new DoublePropertyConfig.Builder("income")
                                        .setCardinality(PropertyConfig.CARDINALITY_REPEATED)
                                        .setScoringEnabled(true)
                                        .build())
                        .addProperty(
                                new LongPropertyConfig.Builder("age")
                                        ...
                                        .build())
                        .addProperty(
                                new BooleanPropertyConfig.Builder("isStarred")
                                        .setCardinality(PropertyConfig.CARDINALITY_OPTIONAL)
                                        .setScoringEnabled(true)
                                        .build())
                        .build();
                ...
                new AppSearchSchema.Builder("Email")
                        .addProperty(
                                new DocumentPropertyConfig.Builder("sender", "Person")
                                        ...
                                        .build())
                        .addProperty(
                                new DocumentPropertyConfig.Builder("recipient", "Person")
                                        .setCardinality(PropertyConfig.CARDINALITY_REPEATED)
                                        .build())
                        .addProperty(
        ...
        GenericDocument sender1 =
                new GenericDocument.Builder<>("namespace", "person1", "Person")
                        .setPropertyBoolean("isStarred", true)
                        .setPropertyDouble("income", 1000, 2000)
                        .setPropertyLong("age", 30)
                        .build();
        GenericDocument sender2 =
                new GenericDocument.Builder<>("namespace", "person2", "Person")
                        .setPropertyBoolean("isStarred", true)
                        .setPropertyDouble("income", 5000, 3000)
                        .setPropertyLong("age", 40)
                        .build();
        GenericDocument recipient =
                new GenericDocument.Builder<>("namespace", "person2", "Person")
                        .setPropertyBoolean("isStarred", true)
                        .setPropertyDouble("income", 2000, 3000)
                        .setPropertyLong("age", 50)
                        .build();

        GenericDocument email =
                new GenericDocument.Builder<>("namespace", "email1", "Email")
                        .setPropertyDocument("sender", sender1, sender2)
                        .setPropertyDocument("recipient", recipient)
                        .setPropertyLong("viewTimes", 10)
                        .build();

        // Put the email document to AppSearch and verify its success.
        AppSearchBatchResult<String, Void> result =
                checkIsBatchResultSuccess(
                        mDb1.putAsync(
                                new PutDocumentsRequest.Builder()
                                        .addGenericDocuments(email)
                                        .build()));
        assertThat(result.getSuccesses()).containsExactly("email1", null);
        assertThat(result.getFailures()).isEmpty();

        // Search and ranking with the scorable properties
        String rankingStrategy =
                "sum(getScorableProperty(\"Email\", \"viewTimes\")) + "
                        + "max(getScorableProperty(\"Email\", \"recipient.age\")) + "
                        + "100 * max(getScorableProperty(\"Email\", \"recipient.isStarred\")) + "
                        + "5 * sum(getScorableProperty(\"Email\", \"sender.income\"))";
        SearchSpec searchSpec =
                new SearchSpec.Builder()
                        .setScorablePropertyRankingEnabled(true)
        ...
        double expectedScore =
                /* viewTimes= */ 10
                        ...
                        /* age= */ 50
                        + 100 * /* isStarred= */ 1
                        + 5 * (1000 + 2000 + 5000 + 3000);
        SearchResultsShim searchResults = mDb1.search("", searchSpec);
        List<SearchResult> results = retrieveAllSearchResults(searchResults);
        assertThat(results).hasSize(1);
        assertThat(results.get(0).getGenericDocument()).isEqualTo(email);
        assertThat(results.get(0).getRankingSignal()).isWithin(0.00001).of(expectedScore);
    }

    @Test
    @RequiresFlagsEnabled(Flags.FLAG_ENABLE_SCORABLE_PROPERTY)
    public void testRankWithScorableProperty_updateSchemaByAddScorableProperty() throws Exception {
        assumeTrue(mDb1.getFeatures().isFeatureSupported(Features.SCHEMA_SCORABLE_PROPERTY_CONFIG));
                ...
                new AppSearchSchema.Builder("Gmail")
                        .addProperty(
                                new StringPropertyConfig.Builder("subject")
                                        ...
                                        .build())
                        .build();
        GenericDocument gmailDoc =
                new GenericDocument.Builder<>("namespace", "id", "Gmail")
                        .setPropertyString("subject", "foo")
                        .build();
        mDb1.setSchemaAsync(new SetSchemaRequest.Builder().addSchemas(schema).build()).get();
        ...
        AppSearchBatchResult<String, Void> result =
                checkIsBatchResultSuccess(
                        mDb1.putAsync(
                                new PutDocumentsRequest.Builder()
                                        .addGenericDocuments(gmailDoc)
                                        .build()));
        assertThat(result.getSuccesses()).containsExactly("id", null);
        assertThat(result.getFailures()).isEmpty();

        // Update the schema by adding a scorable property.
        schema =
                new AppSearchSchema.Builder("Gmail")
                        .addProperty(
                                new StringPropertyConfig.Builder("subject")
        ...
        // Search and rank over the existing doc.
        // The existing document's scorable property has been populated with the default values.
        SearchSpec searchSpec =
                new SearchSpec.Builder()
                        .setScorablePropertyRankingEnabled(true)
                        .setRankingStrategy("sum(getScorableProperty(\"Gmail\", \"important\"))")
                        .build();
        SearchResultsShim searchResults = mDb1.search("", searchSpec);
        List<SearchResult> results = retrieveAllSearchResults(searchResults);
        assertThat(results).hasSize(1);
    ...
    @Test
    @RequiresFlagsEnabled(Flags.FLAG_ENABLE_SCORABLE_PROPERTY)
    public void testRankWithScorableProperty_updateScorableTypeInNestedSchema() throws Exception {
        assumeTrue(mDb1.getFeatures().isFeatureSupported(Features.SCHEMA_SCORABLE_PROPERTY_CONFIG));
        ...
        GenericDocument sender =
                new GenericDocument.Builder<>("namespace", "person1", "Person")
                        .setPropertyDouble("income", 1000)
                        .build();
        GenericDocument recipient =
                new GenericDocument.Builder<>("namespace", "person2", "Person")
                        .setPropertyDouble("income", 5000)
                        .build();
        GenericDocument email =
                new GenericDocument.Builder<>("namespace", "email1", "Email")
                        .setPropertyDocument("sender", sender)
                        .setPropertyDocument("recipient", recipient)
                        .build();
        checkIsBatchResultSuccess(
                mDb1.putAsync(
        ...
        // Search and ranking with the Email.Person.income
        String rankingStrategy =
                "sum(getScorableProperty(\"Email\", \"sender.income\")) + "
                        + "max(getScorableProperty(\"Email\", \"recipient.income\"))";
        SearchSpec searchSpec =
                new SearchSpec.Builder()
                        .setScorablePropertyRankingEnabled(true)
                        .setRankingStrategy(rankingStrategy)
                        .build();
        double expectedScore = 1000 + 5000;
        SearchResultsShim searchResults = mDb1.search("", searchSpec);
        List<SearchResult> results = retrieveAllSearchResults(searchResults);
        assertThat(results).hasSize(1);
        assertThat(results.get(0).getGenericDocument()).isEqualTo(email);
    ...
    @Test
    @RequiresFlagsEnabled(Flags.FLAG_ENABLE_SCORABLE_PROPERTY)
    public void testRankWithScorableProperty_updateSchemaByFlippingScorableType() throws Exception {
        assumeTrue(mDb1.getFeatures().isFeatureSupported(Features.SCHEMA_SCORABLE_PROPERTY_CONFIG));
        ...
        mDb1.setSchemaAsync(
                        new SetSchemaRequest.Builder()
                                .addSchemas(schemaWithPropertyScorable)
                                .build())
                .get();
        ...
        // Update the Schema by updating the property as not scorable
        AppSearchSchema schemaWithPropertyNotScorable =
                new AppSearchSchema.Builder("Gmail")
                        .addProperty(
                                new BooleanPropertyConfig.Builder("important")
                                        .setCardinality(PropertyConfig.CARDINALITY_OPTIONAL)
        ...
        mDb1.setSchemaAsync(
                        new SetSchemaRequest.Builder()
                                .addSchemas(schemaWithPropertyNotScorable)
                                .build())
                .get();
        ...
        mDb1.setSchemaAsync(
                        new SetSchemaRequest.Builder()
                                ...
                                .build())
                .get();
        // Verify that the property can be used for scoring.
        searchResults = mDb1.search("", searchSpec);
        results = retrieveAllSearchResults(searchResults);
        assertThat(results).hasSize(1);
        assertThat(results.get(0).getGenericDocument()).isEqualTo(doc);
        assertThat(results.get(0).getRankingSignal()).isWithin(0.00001).of(1);
    ...
    @Test
    @RequiresFlagsEnabled(Flags.FLAG_ENABLE_SCORABLE_PROPERTY)
    public void testRankWithScorableProperty_reorderSchemaProperties() throws Exception {
        assumeTrue(mDb1.getFeatures().isFeatureSupported(Features.SCHEMA_SCORABLE_PROPERTY_CONFIG));
        ...
        GenericDocument person =
                new GenericDocument.Builder<>("namespace", "person1", "Person")
                        ...
                        .setPropertyLong("age", 30)
                        .build();
        mDb1.setSchemaAsync(new SetSchemaRequest.Builder().addSchemas(personSchema).build()).get();
        checkIsBatchResultSuccess(
                mDb1.putAsync(
        ...
        SearchSpec searchSpec =
                new SearchSpec.Builder()
                        ...
                        .setRankingStrategy(rankingStrategy)
                        .build();
        double expectedRankingScore = 3030;

        SearchResultsShim searchResults = mDb1.search("", searchSpec);
        List<SearchResult> results = retrieveAllSearchResults(searchResults);
        assertThat(results.get(0).getRankingSignal()).isWithin(0.00001).of(expectedRankingScore);

        // Update the schema by swapping the order of property 'age' and 'income'
        personSchema =
                new AppSearchSchema.Builder("Person")
                        .addProperty(
                                new LongPropertyConfig.Builder("age")
        ...
        // Verify that the ranking is still working as expected.
        searchResults = mDb1.search("", searchSpec);
        results = retrieveAllSearchResults(searchResults);
        assertThat(results.get(0).getRankingSignal()).isWithin(0.00001).of(expectedRankingScore);
    }
    ...
    @Test
    @RequiresFlagsEnabled(Flags.FLAG_ENABLE_SCORABLE_PROPERTY)
    public void testRankWithScorableProperty_matchedDocumentHasDifferentSchemaType()
            throws Exception {
        assumeTrue(mDb1.getFeatures().isFeatureSupported(Features.SCHEMA_SCORABLE_PROPERTY_CONFIG));
        AppSearchSchema gmailSchema =
                new AppSearchSchema.Builder("Gmail")
                        .addProperty(
                                new BooleanPropertyConfig.Builder("important")
                                        .setCardinality(PropertyConfig.CARDINALITY_OPTIONAL)
        ...
        AppSearchSchema personSchema =
                new AppSearchSchema.Builder("Person")
                        .addProperty(
                                new LongPropertyConfig.Builder("income")
                                        .setCardinality(PropertyConfig.CARDINALITY_OPTIONAL)
                                        .setScoringEnabled(true)
                                        .build())
                        .build();
        mDb1.setSchemaAsync(
                        new SetSchemaRequest.Builder()
                                .addSchemas(gmailSchema, personSchema)
                                .build())
                .get();
        ...
        GenericDocument gmailDoc =
                new GenericDocument.Builder<>("namespace", "id1", "Gmail")
                        ...
                        .build();
        GenericDocument personDoc =
                new GenericDocument.Builder<>("namespace", "id2", "Person")
                        .setPropertyLong("income", 100)
                        .setScore(1)
                        .build();
        checkIsBatchResultSuccess(
                mDb1.putAsync(
                        new PutDocumentsRequest.Builder()
                                .addGenericDocuments(gmailDoc, personDoc)
                                .build()));
                ...
                new SearchSpec.Builder()
                        ...
                        .setRankingStrategy(
                                "this.documentScore() + sum(getScorableProperty(\"Gmail\","
                                    + " \"important\"))")
                        .build();
        double expectedGmailDocScore = 2;
        double expectedPersonDocScore = 1;

        SearchResultsShim searchResults = mDb1.search("", searchSpec);
        List<SearchResult> results = retrieveAllSearchResults(searchResults);
        assertThat(results).hasSize(2);
        assertThat(results.get(0).getGenericDocument()).isEqualTo(gmailDoc);
        assertThat(results.get(0).getRankingSignal()).isWithin(0.00001).of(expectedGmailDocScore);
        assertThat(results.get(1).getGenericDocument()).isEqualTo(personDoc);
        assertThat(results.get(1).getRankingSignal()).isWithin(0.00001).of(expectedPersonDocScore);
    }

    @Test
    @RequiresFlagsEnabled(Flags.FLAG_ENABLE_SCORABLE_PROPERTY)
    public void testRankWithScorableProperty_matchedDocumentHasNoDataUnderTheRankingProperty()
            throws Exception {
        assumeTrue(mDb1.getFeatures().isFeatureSupported(Features.SCHEMA_SCORABLE_PROPERTY_CONFIG));
        AppSearchSchema gmailSchema =
                new AppSearchSchema.Builder("Gmail")
                        .addProperty(
                                new LongPropertyConfig.Builder("viewTimes")
                                        ...
                                        .build())
                        .build();
        mDb1.setSchemaAsync(new SetSchemaRequest.Builder().addSchemas(gmailSchema).build()).get();

        GenericDocument gmailDoc1 =
                new GenericDocument.Builder<>("namespace", "id1", "Gmail")
                        .setPropertyLong("viewTimes", 100)
                        .setScore(1)
                        .build();
        GenericDocument gmailDoc2 =
                new GenericDocument.Builder<>("namespace", "id2", "Gmail").setScore(1).build();
        checkIsBatchResultSuccess(
                mDb1.putAsync(
                        new PutDocumentsRequest.Builder()
                                .addGenericDocuments(gmailDoc1, gmailDoc2)
                                .build()));
                ...
                new SearchSpec.Builder()
                        ...
                        .setRankingStrategy(
                                "this.documentScore() + sum(getScorableProperty(\"Gmail\","
                                    + " \"viewTimes\"))")
                        .build();
        double expectedGmailDoc1Score = 101;
        double expectedGmailDoc2Score = 1;

        SearchResultsShim searchResults = mDb1.search("", searchSpec);
        List<SearchResult> results = retrieveAllSearchResults(searchResults);
        assertThat(results).hasSize(2);
        assertThat(results.get(0).getGenericDocument()).isEqualTo(gmailDoc1);
        assertThat(results.get(0).getRankingSignal()).isWithin(0.00001).of(expectedGmailDoc1Score);
        assertThat(results.get(1).getGenericDocument()).isEqualTo(gmailDoc2);
        assertThat(results.get(1).getRankingSignal()).isWithin(0.00001).of(expectedGmailDoc2Score);
    }
    ...
    public void testRankWithScorableProperty_joinWithChildQuery() throws Exception {
                ...
                new AppSearchSchema.Builder("Person")
                        ...
                        .addProperty(
                                new BooleanPropertyConfig.Builder("isStarred")
                                        ...
                                        .build())
                        .build();
        AppSearchSchema callLogSchema =
                new AppSearchSchema.Builder("CallLog")
                        .addProperty(
                                new StringPropertyConfig.Builder("personQualifiedId")
                                        .setCardinality(PropertyConfig.CARDINALITY_OPTIONAL)
                                        .setJoinableValueType(
                                                StringPropertyConfig
                                                        .JOINABLE_VALUE_TYPE_QUALIFIED_ID)
                        ...
                        .addProperty(
                                new DoublePropertyConfig.Builder("rfsScore")
                                        ...
                                        .build())
                        .build();
        AppSearchSchema smsLogSchema =
                new AppSearchSchema.Builder("SmsLog")
                        .addProperty(
                                new StringPropertyConfig.Builder("personQualifiedId")
                                        .setCardinality(PropertyConfig.CARDINALITY_OPTIONAL)
                                        .setJoinableValueType(
        ...
        mDb1.setSchemaAsync(
                        new SetSchemaRequest.Builder()
                                .addSchemas(personSchema, callLogSchema, smsLogSchema)
                                .build())
                .get();

        // John will have two CallLog docs to join and one sms log to join.
        GenericDocument personJohn =
                new GenericDocument.Builder<>("namespace", "johnId", "Person")
                        .setPropertyString("name", "John")
                        .setPropertyBoolean("isStarred", true)
        ...
        GenericDocument personKevin =
                new GenericDocument.Builder<>("namespace", "kevinId", "Person")
        ...
        GenericDocument personTim =
                new GenericDocument.Builder<>("namespace", "timId", "Person")
        ...
        GenericDocument johnCallLog1 =
                new GenericDocument.Builder<>("namespace", "johnCallLog1", "CallLog")
                        .setScore(5)
                        .setPropertyDouble("rfsScore", 100, 200)
                        .setPropertyString(
                                "personQualifiedId",
                                DocumentIdUtil.createQualifiedId(
                                        mContext.getPackageName(), DB_NAME_1, personJohn))
                        .build();
        GenericDocument johnCallLog2 =
                new GenericDocument.Builder<>("namespace", "johnCallLog2", "CallLog")
                        .setScore(5)
        ...
        GenericDocument kevinCallLog1 =
                new GenericDocument.Builder<>("namespace", "kevinCallLog1", "CallLog")
                        .setScore(5)
                        .setPropertyDouble("rfsScore", 300, 400)
                        .setPropertyString(
                                "personQualifiedId",
                                DocumentIdUtil.createQualifiedId(
                                        mContext.getPackageName(), DB_NAME_1, personKevin))
                        .build();
        GenericDocument kevinCallLog2 =
                new GenericDocument.Builder<>("namespace", "kevinCallLog2", "CallLog")
                        .setScore(5)
        ...
        GenericDocument johnSmsLog1 =
                new GenericDocument.Builder<>("namespace", "johnSmsLog1", "SmsLog")
                        .setScore(5)
        ...
        GenericDocument kevinSmsLog1 =
                new GenericDocument.Builder<>("namespace", "kevinSmsLog1", "SmsLog")
                        .setScore(5)
        ...
        SearchSpec childSearchSpec =
                new SearchSpec.Builder()
                        .setScorablePropertyRankingEnabled(true)
                        .setRankingStrategy(childRankingStrategy)
                        .build();
        JoinSpec js =
                new JoinSpec.Builder("personQualifiedId")
        ...
        SearchResultsShim searchResults = mDb1.search("", parentSearchSpec);
        List<SearchResult> results = retrieveAllSearchResults(searchResults);
        assertThat(results).hasSize(3);
