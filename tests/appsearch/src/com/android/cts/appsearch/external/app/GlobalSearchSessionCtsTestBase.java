...
public abstract class GlobalSearchSessionCtsTestBase {
    ...
    public void testRemoveObserver_multiplePackages() throws Exception {
        ...
        mGlobalSearchSession.registerObserverCallback(
                mContext.getPackageName(), new ObserverSpec.Builder().build(), EXECUTOR, observer1);
        mGlobalSearchSession.registerObserverCallback(
                "foo", new ObserverSpec.Builder().build(), EXECUTOR, observer1);
        mGlobalSearchSession.registerObserverCallback(
                mContext.getPackageName(), new ObserverSpec.Builder().build(), EXECUTOR, observer2);
        ...
        try {
            ...
            mGlobalSearchSession.unregisterObserverCallback(mContext.getPackageName(), observer2);
        }
    }
                                            ...
                                            new Migrator() {
                                                ...
                                                public GenericDocument onUpgrade(
                                                    ...
                                                    assertThat(document.getSchemaType())
                                                            .isEqualTo("Type1");
                                                    String[] prop =
                                                            document.getPropertyStringArray(
                                                                    "strProp1");
