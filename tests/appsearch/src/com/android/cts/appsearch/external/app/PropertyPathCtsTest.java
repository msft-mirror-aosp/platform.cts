...
public class PropertyPathCtsTest {
    ...
    public void testPathSegmentInvalid() {
        Assert.assertThrows(
                NullPointerException.class, () -> PropertyPath.PathSegment.create(null));

        Throwable e;
        e =
                Assert.assertThrows(
                        IllegalArgumentException.class, () -> PropertyPath.PathSegment.create(""));
    ...
    public void testBuildPropertyPathFromSegmentList() {
        List<PropertyPath.PathSegment> list =
                ImmutableList.of(
