...
public class AppSearchBlobHandleCtsTest {
    ...
    public void testCreateBlobHandle() throws Exception {
        ...
        AppSearchBlobHandle blobHandle =
                AppSearchBlobHandle.createWithSha256(digest, "package1", "db1", "ns");
    ...
    public void testBlobHandleIdentical() throws Exception {
        ...
        AppSearchBlobHandle blobHandle1 =
                AppSearchBlobHandle.createWithSha256(digest, "package", "db", "ns");
    ...
    public void testBlobHandleNotIdentical() throws Exception {
        ...
        AppSearchBlobHandle blobHandle1 =
                AppSearchBlobHandle.createWithSha256(digest1, "package1", "db1", "ns1");
        AppSearchBlobHandle blobHandle2 =
                AppSearchBlobHandle.createWithSha256(digest2, "package1", "db1", "ns1");
        AppSearchBlobHandle blobHandle3 =
                AppSearchBlobHandle.createWithSha256(digest1, "package2", "db1", "ns1");
        AppSearchBlobHandle blobHandle4 =
                AppSearchBlobHandle.createWithSha256(digest1, "package1", "db2", "ns1");
        AppSearchBlobHandle blobHandle5 =
                AppSearchBlobHandle.createWithSha256(digest1, "package1", "db1", "ns2");
