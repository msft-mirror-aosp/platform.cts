...
public class AppSearchOpenBlobForWriteResponseTest {
    ...
    public void testBuildAndGet() throws Exception {
        ...
        AppSearchBlobHandle blobHandle3 =
                AppSearchBlobHandle.createWithSha256(digest3, "package1", "db1", "ns");
        AppSearchBlobHandle blobHandle4 =
                AppSearchBlobHandle.createWithSha256(digest4, "package1", "db1", "ns");
        ...
        try (AppSearchOpenBlobForWriteResponse response =
            ...
            AppSearchBatchResult<AppSearchBlobHandle, ParcelFileDescriptor> outResult =
                    response.getResult();
            assertThat(outResult.getSuccesses())
                    .containsExactly(blobHandle1, mPfd, blobHandle3, mPfd);
            assertThat(outResult.getFailures())
                    .containsExactly(blobHandle2, mFailureResult, blobHandle4, mFailureResult);
            assertThat(outResult.getAll())
                    .containsExactly(
                            blobHandle1,
                            mSuccessResult,
                            blobHandle2,
