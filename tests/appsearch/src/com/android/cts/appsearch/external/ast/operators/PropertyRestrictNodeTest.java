...
public class PropertyRestrictNodeTest {
    ...
    public void testConstructor_throwsOnNullPointer() {
        ...
        assertThrows(
                NullPointerException.class, () -> new PropertyRestrictNode(propertyPath, textNode));
    }
    ...
    public void testToString_returnsCorrectString() {
        ...
        assertThat(propertyRestrictNode.toString()).isEqualTo("(example.property.segment:(foo))");
    }
}
