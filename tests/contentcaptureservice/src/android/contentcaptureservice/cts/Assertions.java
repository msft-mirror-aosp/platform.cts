...
final class Assertions {
    ...
    /**
     * This method is used to remove unexpected events if the test should only contain session level
     * events. In special case, there are some events, such as {@link #TYPE_WINDOW_BOUNDS_CHANGED}
     * and {@link #TYPE_VIEW_INSETS_CHANGED}, will be accidentally generated by the system. Because
     * these events were not expected in the test, remove them if needed. Also remove {@link
     * #TYPE_SESSION_FLUSH} because the above events can be generated as an atomic event, in which
     * case they are followed by the flush event.
     */
