...
public class MediaStore_FilesTest {
    ...
    public void testGetContentUri() throws Exception {
        ...
        // path properly.
        String dataPath = new File(MediaProviderTestUtils.stageDir(mVolumeName),
        ...
        String updatedPath = new File(MediaProviderTestUtils.stageDir(mVolumeName),
        ...
        values.clear();
        try {
            File stageDir = new File(MediaProviderTestUtils.stageDir(mVolumeName),
    ...
    public void testAccess() throws Exception {
        final String path = MediaProviderTestUtils.getVolumePath(resolveVolumeName(mVolumeName))
                .getAbsolutePath();
        final Uri updateUri = ContentUris.withAppendedId(mExternalFiles,
                ContentUris.parseId(
                        MediaProviderTestUtils.stageMedia(R.raw.volantis, mExternalImages)));
    ...
    public void testUpdateMediaType() throws Exception {
        final File file = new File(MediaProviderTestUtils.stageDir(mVolumeName),
    ...
    public void testInPlaceUpdate_mediaFileWithInvalidRelativePath() throws Exception {
        final File file = new File(MediaProviderTestUtils.stageDownloadDir(mVolumeName),
                "test" + System.nanoTime() + ".mp3");
        MediaProviderTestUtils.stageFile(R.raw.testmp3, file);
        ...
        final Uri scannedUri = MediaProviderTestUtils.scanFile(file);
        MediaProviderTestUtils.setOwner(scannedUri,
