...
public class MediaStorePlacementTest {
    ...
    public void testDefault() throws Exception {
        final Uri uri = MediaProviderTestUtils.stageMedia(R.drawable.scenery,
                mExternalImages, "image/jpeg");

        // By default placed under "Pictures" with sane name
        final File before = MediaProviderTestUtils.getRelativeFile(uri);
    ...
    public void testDisplayName_SameMime() throws Exception {
        ...
        final File after = MediaProviderTestUtils.getRelativeFile(uri);
    ...
    public void testDirectory_InsideSandbox() throws Exception {
        ...
        final File dir = MediaProviderTestUtils.getVolumePath(mVolumeName);
        final File file = MediaProviderTestUtils.stageFile(R.drawable.scenery,
                Environment.buildPath(dir, "Android", "media", MODULE_NAME,
                        System.nanoTime() + ".jpg"));
        final Uri uri = MediaProviderTestUtils.scanFile(file);

        assertTrue(updatePlacement(uri, Optional.of("Android/media/" + MODULE_NAME + "/foo"),
                null));
        assertFalse(updatePlacement(uri,
    ...
    public void testRelated() throws Exception {
        ...
        assertEquals(MediaProviderTestUtils.getRelativeFile(unusualUri).getParent(),
                MediaProviderTestUtils.getRelativeFile(probeUri).getParent());
