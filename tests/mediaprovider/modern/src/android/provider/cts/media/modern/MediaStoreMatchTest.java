...
public class MediaStoreMatchTest {
    ...
    private void verifyMatch(String columnName, String queryArg) throws Exception {
        final Uri pos = MediaProviderTestUtils.stageMedia(R.raw.scenery, mExternalImages);
        final Uri neg = MediaProviderTestUtils.stageMedia(R.raw.scenery, mExternalImages);
