...
public class MediaStore_Video_MediaTest {
    ...
    public void testStoreVideoMediaExternal() throws Exception {
        ...
        final File videoFile = MediaProviderTestUtils.stageFile(R.raw.testvideo,
        ...
        MediaProviderTestUtils.waitUntilExists(videoFile);
    ...
    private Uri insertVideo(Context context) throws IOException {
        ...
        MediaProviderTestUtils.stageFile(R.raw.testvideo, file);
    ...
    public void testOriginalAccess() throws Exception {
        final Uri publishUri = MediaProviderTestUtils.stageMedia(R.raw.testvideo_meta,
                mExternalVideo,
                "video/mp4");
    ...
    public void testIsoLocationRedaction() throws Exception {
        ...
        for (int i = 0; i < videoIds.length; i++) {
            uris[i] = MediaProviderTestUtils.stageMedia(videoIds[i], mExternalVideo, "video/mp4");
        }
        ...
        for (int i = 0; i < uris.length; i++) {
            MediaProviderTestUtils.clearOwner(uris[i]);
    ...
    public void testCanonicalize() throws Exception {
        ...
        final Uri a = MediaProviderTestUtils.scanFileFromShell(
                MediaProviderTestUtils.stageFile(R.raw.testvideo, new File(dir, "a.mp4")));
        final Uri b = MediaProviderTestUtils.scanFileFromShell(
                MediaProviderTestUtils.stageFile(R.raw.testvideo_meta, new File(dir, "b.mp4")));
        final Uri c = MediaProviderTestUtils.scanFileFromShell(
                MediaProviderTestUtils.stageFile(R.raw.testvideo, new File(dir, "c.mp4")));
        ...
        final Uri d = MediaProviderTestUtils.scanFileFromShell(
                MediaProviderTestUtils.stageFile(R.raw.testvideo_meta, new File(dir, "d.mp4")));
    ...
    public void testMetadata() throws Exception {
        ...
        final Uri uri = MediaProviderTestUtils.stageMedia(R.raw.testvideo_meta, mExternalVideo,
                "video/mp4");
