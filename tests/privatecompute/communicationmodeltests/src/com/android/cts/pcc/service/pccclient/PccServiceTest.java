...
public class PccServiceTest {
    ...
    public static final ComponentName PCC_SERVICE_COMPONENT =
            new ComponentName(
                    "com.android.cts.pcc.service.pccclient",
    ...
    @Test
    public void bind_regularServiceInPccSandbox_correctBinderReceived() throws Exception {
        Intent intent = new Intent();
    ...
    @Test
    public void bind_sendBinder_doesNotThrow() throws Exception {
        Intent intent = new Intent();
        intent.setComponent(PCC_SERVICE_COMPONENT);
        mContext.bindService(intent, mConnection, Context.BIND_AUTO_CREATE);
    ...
    @Test
    public void bind_sendWritablePfd_doesNotThrow() throws Exception {
        Intent intent = new Intent();
        intent.setComponent(PCC_SERVICE_COMPONENT);
        mContext.bindService(intent, mConnection, Context.BIND_AUTO_CREATE);
    ...
    @Test
    public void bind_sendCustomParcelable_doesNotThrow() throws Exception {
        Intent intent = new Intent();
        intent.setComponent(PCC_SERVICE_COMPONENT);
        mContext.bindService(intent, mConnection, Context.BIND_AUTO_CREATE);
    ...
    @Test
    public void bind_sendParcelableWithDepth101_doesNotThrow() throws Exception {
        Intent intent = new Intent();
        intent.setComponent(PCC_SERVICE_COMPONENT);
        mContext.bindService(intent, mConnection, Context.BIND_AUTO_CREATE);
