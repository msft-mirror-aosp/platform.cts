...
public class IsDeviceManagedTest {
    ...
    public void isDeviceManaged_organizationOwnedProfileOwnerManaging_recentSDK_returnsTrue() {
        assertThat(dpc(sDeviceState).devicePolicyManager().isDeviceManaged()).isTrue();
    }
    ...
    public void isDeviceManaged_organizationOwnedProfileOwnerManaging_olderSDK_returnsFalse() {
    ...
    @Postsubmit(reason = "new test")
    @RequireRunOnWorkProfile
    public void isDeviceManaged_nonOrganizationOwnedProfileOwnerManaging_returnsFalse() {
        assertThat(dpc(sDeviceState).devicePolicyManager().isDeviceManaged()).isFalse();
    }
}
