                ...
                testApp.install().use { testApp ->
                    ...
                    try {
                        ...
                        assertThat(
                            metrics.query()
                                    .whereType()
                                    .isEqualTo(EventId.SET_LOCKTASK_MODE_ENABLED_VALUE)
                                    .whereAdminPackageName()
                                    .isEqualTo(deviceState.dpc().packageName())
                                    .whereBoolean()
                                    .isTrue()
                                    .whereStrings()
                                    .contains(testApp.packageName())
                        ).wasLogged()
                    } finally {
            ...
            testApp.install().use { testApp ->
                secondTestApp.install().use { testApp2 ->
                    ...
                    try {
                        ...
                        assertThat(activity2.activity()
                                .events()
                                .activityDestroyed()).eventOccurred()
                        assertThat(TestApis.activities().lockTaskModeState).isEqualTo(
                            LOCK_TASK_MODE_LOCKED
                        )
                        assertThat(TestApis.activities().foregroundActivity()).isEqualTo(
