...
public final class ManagedEsimOutgoingTransferPolicyScopeUser
...
public final class ManagedEsimOutgoingTransferPolicyScopeDevice

// Policy definition that runs with POLICY_SCOPE_PARENT_USER.
// Generated by running `cts-policy-tests-generator MANAGED_ESIM_OUTGOING_TRANSFER_POLICY`.
@EnterprisePolicy(dpc = [], permissions = [])
public final class ManagedEsimOutgoingTransferPolicyScopeParentUser
...
@UsesEnterprisePolicies(
    ...
    scopeDevice = ManagedEsimOutgoingTransferPolicyScopeDevice::class,
    scopeParentUser = ManagedEsimOutgoingTransferPolicyScopeParentUser::class,
)
@ApiTest(
    apis =
        [
