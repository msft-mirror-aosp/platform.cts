...
@EnterprisePolicy(
    ...
    permissions =
        [
            Permission(
                appliedWith = ["android.permission.MANAGE_DEVICE_POLICY_SCREEN_CAPTURE"],
                appliesTo = APPLIES_TO_OWN_USER,
            )
        ],
)
public final class ScreenCapturePolicyScopeUser
...
public final class ScreenCapturePolicyScopeDevice

// Policy definition that runs with POLICY_SCOPE_PARENT_USER.
// Generated by running `cts-policy-tests-generator SCREEN_CAPTURE`.
@EnterprisePolicy(dpc = [], permissions = []) public final class ScreenCapturePolicyScopeParentUser
...
@UsesEnterprisePolicies(
    ...
    scopeDevice = ScreenCapturePolicyScopeDevice::class,
    scopeParentUser = ScreenCapturePolicyScopeParentUser::class,
)
@ApiTest(
    apis =
        [
...
class ScreenCaptureGeneratedTest : CommonPolicyTests<Int>() {
    ...
    override val validValues =
        listOf(PolicyIdentifier.SCREEN_CAPTURE_DISALLOWED, PolicyIdentifier.SCREEN_CAPTURE_ALLOWED)
