...
// Generated by running `cts-policy-tests-generator BLUETOOTH_SHARING`.
@EnterprisePolicy(
    dpc =
        [
    ...
    permissions =
        [
            Permission(
                appliedWith = ["android.permission.MANAGE_DEVICE_POLICY_BLUETOOTH"],
                appliesTo = APPLIES_TO_OWN_USER,
            )
        ],
)
public final class BluetoothSharingPolicy_ScopeUser
...
public final class BluetoothSharingPolicy_ScopeDevice

// Policy definition that runs with POLICY_SCOPE_PARENT_USER.
// Generated by running `cts-policy-tests-generator BLUETOOTH_SHARING`.
@EnterprisePolicy(dpc = [], permissions = [])
public final class BluetoothSharingPolicy_ScopeParentUser

@RunWith(BedsteadJUnit4::class)
@RequireFlagsEnabled(Flags.FLAG_POLICY_STREAMLINING, Flags.FLAG_POLICY_STREAMLINING_TESTS)
@UsesEnterprisePolicies(
    scopeUser = BluetoothSharingPolicy_ScopeUser::class,
    scopeDevice = BluetoothSharingPolicy_ScopeDevice::class,
    scopeParentUser = BluetoothSharingPolicy_ScopeParentUser::class,
)
@ApiTest(
    apis =
        [
            "android.app.admin.PolicyIdentifier#BLUETOOTH_SHARING",
            "android.app.admin.PolicyIdentifier#BLUETOOTH_SHARING_ALLOWED",
            "android.app.admin.PolicyIdentifier#BLUETOOTH_SHARING_DISALLOWED",
        ]
)
class BluetoothSharingGeneratedTest : CommonPolicyTests<Int>() {

    override val policyIdentifier = PolicyIdentifier.BLUETOOTH_SHARING

    override val validValues =
        listOf(
            PolicyIdentifier.BLUETOOTH_SHARING_DISALLOWED,
            PolicyIdentifier.BLUETOOTH_SHARING_ALLOWED,
        )
