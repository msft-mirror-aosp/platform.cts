...
public final class FactoryResetPolicy_ScopeUser
...
public final class FactoryResetPolicy_ScopeDevice

// Policy definition that runs with POLICY_SCOPE_PARENT_USER.
// Generated by running `cts-policy-tests-generator FACTORY_RESET`.
@EnterprisePolicy(dpc = [], permissions = []) public final class FactoryResetPolicy_ScopeParentUser
...
@UsesEnterprisePolicies(
    scopeUser = FactoryResetPolicy_ScopeUser::class,
    scopeDevice = FactoryResetPolicy_ScopeDevice::class,
    scopeParentUser = FactoryResetPolicy_ScopeParentUser::class,
)
@ApiTest(
    apis =
        [
