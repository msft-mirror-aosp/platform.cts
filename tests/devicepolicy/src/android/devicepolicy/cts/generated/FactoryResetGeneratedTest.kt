...
// Generated by running `cts-policy-tests-generator FACTORY_RESET`.
@EnterprisePolicy(
    dpc =
        [
    ...
    permissions =
        [
            Permission(
                appliedWith = ["android.permission.MANAGE_DEVICE_POLICY_FACTORY_RESET"],
                appliesTo = APPLIES_TO_OWN_USER,
            )
        ],
)
public final class FactoryResetPolicyScopeUser
...
public final class FactoryResetPolicyScopeDevice

// Policy definition that runs with POLICY_SCOPE_PARENT_USER.
// Generated by running `cts-policy-tests-generator FACTORY_RESET`.
@EnterprisePolicy(dpc = [], permissions = []) public final class FactoryResetPolicyScopeParentUser

@RunWith(BedsteadJUnit4::class)
@RequireFlagsEnabled(
    Flags.FLAG_POLICY_STREAMLINING,
    Flags.FLAG_POLICY_STREAMLINING_TESTS,
    Flags.FLAG_POLICY_STREAMLINING_DISALLOW_FACTORY_RESET,
)
@UsesEnterprisePolicies(
    scopeUser = FactoryResetPolicyScopeUser::class,
    scopeDevice = FactoryResetPolicyScopeDevice::class,
    scopeParentUser = FactoryResetPolicyScopeParentUser::class,
)
@ApiTest(
    apis =
        [
            "android.app.admin.PolicyIdentifier#FACTORY_RESET",
            "android.app.admin.PolicyIdentifier#FACTORY_RESET_ALLOWED",
            "android.app.admin.PolicyIdentifier#FACTORY_RESET_DISALLOWED",
        ]
)
class FactoryResetGeneratedTest : CommonPolicyTests<Int>() {

    override val policyIdentifier = PolicyIdentifier.FACTORY_RESET

    override val validValues =
        listOf(PolicyIdentifier.FACTORY_RESET_DISALLOWED, PolicyIdentifier.FACTORY_RESET_ALLOWED)
