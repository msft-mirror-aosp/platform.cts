...
@EnterprisePolicy(dpc = [], permissions = []) public final class AutoTimeZonePolicyScopeUser
...
public final class AutoTimeZonePolicyScopeDevice

// Policy definition that runs with POLICY_SCOPE_PARENT_USER.
// Generated by running `cts-policy-tests-generator AUTO_TIME_ZONE`.
@EnterprisePolicy(dpc = [], permissions = []) public final class AutoTimeZonePolicyScopeParentUser
