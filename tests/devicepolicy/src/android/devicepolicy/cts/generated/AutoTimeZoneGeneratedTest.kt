...
// Generated by running `cts-policy-tests-generator AUTO_TIME_ZONE`.
@EnterprisePolicy(dpc = [], permissions = []) public final class AutoTimeZonePolicy_ScopeUser
...
public final class AutoTimeZonePolicy_ScopeDevice

// Policy definition that runs with POLICY_SCOPE_PARENT_USER.
// Generated by running `cts-policy-tests-generator AUTO_TIME_ZONE`.
@EnterprisePolicy(dpc = [], permissions = []) public final class AutoTimeZonePolicy_ScopeParentUser
...
class AutoTimeZoneGeneratedTest : CommonPolicyTests<Int>() {

    override val policyIdentifier = PolicyIdentifier.AUTO_TIME_ZONE

    override val validValues =
        listOf(
            PolicyIdentifier.AUTO_TIME_ZONE_USER_CHOICE,
