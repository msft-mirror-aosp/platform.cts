...
@EnterprisePolicy(dpc = [], permissions = []) public final class LockscreenMessagePolicy_ScopeUser
...
public final class LockscreenMessagePolicy_ScopeDevice
...
@UsesEnterprisePolicies(
    ...
    scopeParentUser = LockscreenMessagePolicy_ScopeParentUser::class,
)
