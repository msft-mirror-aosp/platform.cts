...
@EnterprisePolicy(dpc = [], permissions = []) public final class LockscreenMessagePolicyScopeUser
...
@ApiTest(apis = ["android.app.admin.PolicyIdentifier#LOCKSCREEN_MESSAGE"])
