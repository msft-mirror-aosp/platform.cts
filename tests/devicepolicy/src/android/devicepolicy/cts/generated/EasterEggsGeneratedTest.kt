...
public final class EasterEggsPolicyScopeUser
...
public final class EasterEggsPolicyScopeDevice

// Policy definition that runs with POLICY_SCOPE_PARENT_USER.
// Generated by running `cts-policy-tests-generator EASTER_EGGS`.
@EnterprisePolicy(dpc = [], permissions = []) public final class EasterEggsPolicyScopeParentUser
...
@UsesEnterprisePolicies(
    scopeUser = EasterEggsPolicyScopeUser::class,
    scopeDevice = EasterEggsPolicyScopeDevice::class,
    scopeParentUser = EasterEggsPolicyScopeParentUser::class,
)
@ApiTest(
    apis =
        [
