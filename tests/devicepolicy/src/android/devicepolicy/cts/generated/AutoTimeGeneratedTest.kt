...
@EnterprisePolicy(dpc = [], permissions = []) public final class AutoTimePolicyScopeUser
...
public final class AutoTimePolicyScopeDevice

// Policy definition that runs with POLICY_SCOPE_PARENT_USER.
// Generated by running `cts-policy-tests-generator AUTO_TIME`.
@EnterprisePolicy(dpc = [], permissions = []) public final class AutoTimePolicyScopeParentUser
