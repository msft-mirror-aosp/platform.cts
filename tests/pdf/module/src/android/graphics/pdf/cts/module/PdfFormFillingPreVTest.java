...
public class PdfFormFillingPreVTest {
    ...
    public void applyEdits_multipleFormEditRecords_returnsEmptyList() throws IOException {
        ...
        verifyApplyEditsPreV(CLICK_FORM, 0, positions, beforeWidgetInfos, records,
                afterWidgetInfos);
    }
    ...
    public void applyEdits_singleInvalidFormEditRecord_returnsRecord() throws IOException {
        ...
        verifyApplyEditsPreVNotNull(CLICK_FORM, 0, positions, beforeWidgetInfos, records,
    ...
    private void verifyFormWidgetInfoPreV(@RawRes int docRes, int pageNum, Point position,
            FormWidgetInfo expectedInfo) throws Exception {
        try (PdfRendererPreV renderer = createPreVRenderer(docRes, mContext, null)) {
    ...
    private void verifyFormWidgetInfosPreV(@RawRes int docRes, int pageNum,
    ...
    private void verifyApplyEdit(@RawRes int docRes, int pageNum, Point position,
        ...
        verifyApplyEditPreV(docRes, pageNum, position, expectedInfoBefore, editRecord,
                expectedInfoAfter, expectedInvalidRects);
    }

    private void verifyApplyEditPreV(@RawRes int docRes, int pageNum, Point position,
            FormWidgetInfo expectedInfoBefore, FormEditRecord editRecord,
            FormWidgetInfo expectedInfoAfter, List<Rect> expectedInvalidRects) throws Exception {
        try (PdfRendererPreV renderer = createPreVRenderer(docRes, mContext, null)) {
            try (PdfRendererPreV.Page page = renderer.openPage(pageNum)) {
    ...
    private void verifyApplyEditsPreV(@RawRes int docRes, int pageNum, List<Point> positions,
    ...
    private void verifyApplyEditsPreVNotNull(@RawRes int docRes, int pageNum, List<Point> positions,
            List<FormWidgetInfo> expectedInfosBefore, List<FormEditRecord> editRecords,
    ...
    private void verifyApplyEditsPreVDocumentClosed(@RawRes int docRes, int pageNum,
    ...
    private void verifyApplyEditsPreVPageClosed(@RawRes int docRes, int pageNum,
            List<FormEditRecord> editRecords) throws IOException {
        try (PdfRendererPreV renderer = createPreVRenderer(docRes, mContext, null)) {
            PdfRendererPreV.Page page = renderer.openPage(pageNum);
            page.close();
    ...
    private void verifyApplyEditThrowsExceptionPreV(@RawRes int docRes, int pageNum,
            FormEditRecord editRecord) throws Exception {
        try (PdfRendererPreV renderer = createPreVRenderer(docRes, mContext, null)) {
            try (PdfRendererPreV.Page page = renderer.openPage(pageNum)) {
