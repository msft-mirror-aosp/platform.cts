...
public class PdfRendererTest {
    ...
    public void testGetPdfPageAnnotations_pdfWithStampAnnotation() throws Exception {
        try (PdfRenderer renderer = createRenderer(ONE_STAMP_ANNOTATION, mContext);
            ...
            assertThat(pageObjects.get(0).getPdfObjectType()).isEqualTo(IMAGE);
    ...
    public void testAddStampAnnotation() throws IOException {
        try (PdfRenderer renderer = createRenderer(EMPTY_PDF, mContext);
            ...
            assertThat(stampAnnotationObjects.get(0).getPdfObjectType()).isEqualTo(IMAGE);
    ...
    public void testGetPdfPageObject_pdfWithOnePathAndOneImagePageObject() throws IOException {
        try (PdfRenderer renderer = createRenderer(ONE_PATH_ONE_IMAGE_PAGE_OBJECT, mContext);
            ...
            int imagePageObjectCount = getPageObjectTypeCount(pdfPageObjects, IMAGE);
    ...
    public void testGetPageAnnotationsThrowsIllegalStateException_WhenPageClosed()
            throws IOException {
        PdfRenderer renderer = createRenderer(ONE_STAMP_ANNOTATION, mContext);
        PdfRenderer.Page firstPage = renderer.openPage(0);
        firstPage.close();
