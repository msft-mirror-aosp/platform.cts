...
public class FgsTimeoutHelper {
    private FgsTimeoutHelper() {
    }

    public static final String TAG = "FgsTimeoutTest";
     ...
     */
    public static final String TEST_PACKAGE = "android.app.cts.fgstimeouttest";

    /**
     * Package name of this helper app.
     */
    public static final String HELPER_PACKAGE = "android.app.cts.fgstimeouttesthelper";
    ...
    /**
     * Set a {@link FgsTimeoutMessage} to an {@link Intent}.
     */
    public static Intent setMessage(Intent i, FgsTimeoutMessage message) {
        i.putExtra(EXTRA_MESSAGE, message);
        return i;
    }

    /**
     * Get a {@link FgsTimeoutMessage} from an {@link Intent}.
     */
    public static FgsTimeoutMessage getMessage(Intent i) {
        return Objects.requireNonNull(i.getParcelableExtra(EXTRA_MESSAGE, FgsTimeoutMessage.class));
    }

    /**
     * Sends a message back to the main test package.
     */
    public static void sendBackMessage(FgsTimeoutMessage m) {
    ...
    public static void sendBackAckMessage() {
        FgsTimeoutMessage m = new FgsTimeoutMessage();
        m.setAck(true);
        sendMessageToMainTest(m);
    }
    ...
    public static void sendBackMethodName(Class<?> clazz, String methodName,
            Consumer<FgsTimeoutMessage> modifier) {
        FgsTimeoutMessage m = new FgsTimeoutMessage();
     ...
     */
    public static FgsTimeoutMessage sendMessageToMainTest(FgsTimeoutMessage args) {
        final Bundle inBundle = new Bundle();
        inBundle.putParcelable(FgsTimeoutHelper.EXTRA_MESSAGE, args);

        final Bundle outBundle = sContext.getContentResolver().call(TEST_PACKAGE, "", "", inBundle);
        outBundle.setClassLoader(FgsTimeoutMessage.class.getClassLoader());

        return Objects.requireNonNull(
                outBundle.getParcelable(FgsTimeoutHelper.EXTRA_MESSAGE, FgsTimeoutMessage.class));
    }

    /**
     * Call CallProvider.call() to get the current test info.
     */
    public static FgsTimeoutMessage getCurrentTestInfo() {
        return sendMessageToMainTest(new FgsTimeoutMessage().setCallGetTestInfo(true));
    }
