...
public class CallProvider extends ContentProvider {
    ...
    /**
     * Called by the helper app.
     * The actual handling code is in {@link #handleCall(FgsTimeoutMessage)}.
     */
    @Override
    public Bundle call(String method, String arg, Bundle extras) {
        extras.setClassLoader(this.getClass().getClassLoader());
        final FgsTimeoutMessage args =
                extras.getParcelable(FgsTimeoutHelper.EXTRA_MESSAGE, FgsTimeoutMessage.class);

        final FgsTimeoutMessage reply = handleCall(args);

        final Bundle ret = new Bundle();
        ret.putParcelable(FgsTimeoutHelper.EXTRA_MESSAGE, reply);
    ...
    private static final ArrayList<FgsTimeoutMessage> sMessageQueue = new ArrayList<>();

    private static FgsTimeoutMessage handleCall(FgsTimeoutMessage args) {
        ...
        // Just return an ack.
        return new FgsTimeoutMessage().setAck(true);
    }
