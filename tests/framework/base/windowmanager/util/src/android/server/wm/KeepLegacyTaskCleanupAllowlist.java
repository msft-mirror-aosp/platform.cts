...
public class KeepLegacyTaskCleanupAllowlist {
    ...
    private static final List<String> ALLOWLIST = Arrays.asList(
            ...
            "android.server.biometrics.BiometricActivityTests",
            "android.server.biometrics.BiometricCryptoTests",
            "android.server.biometrics.BiometricPromptContentViewTest",
            "android.server.biometrics.BiometricPromptLogoTests",
            "android.server.biometrics.BiometricSecurityTests",
            "android.server.biometrics.BiometricServiceTests",
            "android.server.biometrics.BiometricSimpleTests",
            "android.server.biometrics.fingerprint.FingerprintManagerTest",
            ...
            "android.server.wm.multidisplay.MultiDisplayKeyguardTests",
            "android.server.wm.multidisplay.MultiDisplayLockedKeyguardTests",
            "android.server.wm.multidisplay.MultiDisplayPolicyTests",
            "android.server.wm.multidisplay.MultiDisplayPrivateDisplayTests",
            "android.server.wm.multidisplay.MultiDisplaySecurityTests",
            "android.server.wm.multidisplay.MultiDisplaySystemDecorationTests",
            "android.server.wm.other.AnrTests",
            "android.server.wm.other.CompatScaleTests",
            "android.server.wm.other.DeprecatedAbiTest",
            "android.server.wm.other.DragDropCompatTest",
            "android.server.wm.other.DragDropTest",
            "android.server.wm.other.DreamManagerServiceTests",
            "android.server.wm.other.EnsureBarContrastTest",
            "android.server.wm.other.KeepClearRectsTests",
            "android.server.wm.other.LockTaskModeTests",
            "android.server.wm.other.PictureInPictureParamsTest",
            "android.server.wm.other.PinnedStackTests",
            "android.server.wm.other.PrereleaseSdkTest",
            "android.server.wm.other.PrivacyIndicatorBoundsTests",
            "android.server.wm.other.RobustnessTests",
            "android.server.wm.other.TvMaxWindowSizeTests",
            ...
            "android.server.wm.window.AddWindowAsUserTest",
            "android.server.wm.window.AlertWindowsTests",
            "android.server.wm.window.CrossAppDragAndDropTests",
            "android.server.wm.window.DeprecatedTargetSdkTest",
            "android.server.wm.window.HideOverlayWindowsTest",
            "android.server.wm.window.MultiWindowAvailabilityTests",
