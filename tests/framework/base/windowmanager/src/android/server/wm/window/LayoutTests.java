...
public class LayoutTests extends WindowManagerTestBase {
    ...
    public void testAddingImmersiveWindow() throws InterruptedException {
        assumeFalse("Automotive device implementations: [3.8/A] MAY restrict the application" +
                ...
                " immersive documentation", isCar() && remoteInsetsControllerControlsSystemBars());
                ...
                .runOnMainSync(
                        () -> {
                            ...
                            view.setSystemUiVisibility(
                                    SYSTEM_UI_FLAG_IMMERSIVE_STICKY | SYSTEM_UI_FLAG_HIDE_ALL);
                            view.setOnSystemUiVisibilityChangeListener(
                                    visibility -> {
                                        if ((visibility & SYSTEM_UI_FLAG_HIDE_ALL)
                            ...
                            // Use a sub window type so the test is robust when remote inset
                            // controller is used.
    ...
    public void testChangingFocusableFlag() throws Exception {
        ...
        PollingCheck.check(
                "Child window must get key event.",
                TIMEOUT_RECEIVE_KEY,
                () -> {
