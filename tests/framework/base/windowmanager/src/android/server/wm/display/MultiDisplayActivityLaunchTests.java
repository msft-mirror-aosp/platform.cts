...
/**
 * Build/Install/Run:
 *     atest CtsWindowManagerDeviceDisplay:MultiDisplayActivityLaunchTests
 *
...
public class MultiDisplayActivityLaunchTests extends MultiDisplayTestBase {
    ...
    public void testMoveToDisplayOnLaunch() {
        ...
        final int rootTaskNum = mWmState.getDisplay(DEFAULT_DISPLAY).getRootTasks().size();
        ...
        final int rootTaskNumFinal = mWmState.getDisplay(DEFAULT_DISPLAY).getRootTasks().size();
        assertEquals(
