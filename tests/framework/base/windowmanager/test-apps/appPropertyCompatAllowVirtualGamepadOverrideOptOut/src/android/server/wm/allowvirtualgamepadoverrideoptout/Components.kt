...
package android.server.wm.allowvirtualgamepadoverrideoptout

import android.server.wm.component.ComponentsProvider
import android.server.wm.component.forceStopPackage

/** Constants for opt-out virtual gamepad override test components. */
object Components : ComponentsProvider() {

    /** Activity in the app with application level component property. */
    @JvmField
    val ALLOW_VIRTUAL_GAMEPAD_OVERRIDE_OPT_OUT_ACTIVITY =
        component("AllowVirtualGamepadOverrideOptOutActivity")
