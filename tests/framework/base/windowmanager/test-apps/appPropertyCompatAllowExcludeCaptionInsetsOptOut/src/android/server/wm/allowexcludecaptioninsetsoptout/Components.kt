...
package android.server.wm.allowexcludecaptioninsetsoptout

import android.server.wm.component.ComponentsProvider
import android.server.wm.component.forceStopPackage

/** Constants for allow exclude caption insets opt out test components. */
object Components : ComponentsProvider() {

    /** Activity in the app with application level component property. */
    @JvmField
    val ALLOW_EXCLUDE_CAPTION_INSETS_OPT_OUT_ACTIVITY =
        component("AllowExcludeCaptionInsetsOptOutActivity")
