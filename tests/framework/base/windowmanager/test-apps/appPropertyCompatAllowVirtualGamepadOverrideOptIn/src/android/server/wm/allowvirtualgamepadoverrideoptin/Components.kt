...
package android.server.wm.allowvirtualgamepadoverrideoptin

import android.server.wm.component.ComponentsProvider
import android.server.wm.component.forceStopPackage

/** Constants for opt-in virtual gamepad override test components. */
object Components : ComponentsProvider() {

    /** Activity in the app with application level component property. */
    @JvmField
    val ALLOW_VIRTUAL_GAMEPAD_OVERRIDE_OPT_IN_ACTIVITY =
        component("AllowVirtualGamepadOverrideOptInActivity")
