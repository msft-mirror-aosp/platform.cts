...
class AttributionTest {
    ...
    private fun noteProxyOpForAttribution(
        attributionForContextCreation: String,
        attributionForNoteOp: String
    ) {
        ...
        appOpsManager.noteProxyOp(OPSTR_WIFI_SCAN, APP_PKG, appUid, attributionForNoteOp,
            "message")
    }

    private fun startProxyOpForAttribution(
        attributionForContextCreation: String,
        attributionForNoteOp: String
    ) {
        val ctx = context.createAttributionContext(attributionForContextCreation)
    ...
    private fun getPersistedAttribution(attribution: String): String? {
        ...
        return entry.attributedOpEntries[attribution]?.
            getLastProxyInfo(OP_FLAGS_ALL)?.attributionTag
    }
}
