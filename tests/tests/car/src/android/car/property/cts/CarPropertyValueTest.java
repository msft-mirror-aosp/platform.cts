...
public final class CarPropertyValueTest extends AbstractCarTestCase {
    private static final List<Integer> SUPPORTED_PROPERTY_STATUSES =
            Arrays.asList(
    ...
    private CarPropertyValue<?> getCarPropertyValue(
            CarPropertyManager carPropertyManager,
            CarPropertyConfig<?> carPropertyConfig,
            int areaId) {
        try {
            return carPropertyManager.getProperty(
                    carPropertyConfig.getPropertyType(), carPropertyConfig.getPropertyId(), areaId);
    ...
    public void testGetStatus() {
        for (CarPropertyValue propertyValue : mCarPropertyValues) {
            assertThat(propertyValue.getStatus()).isIn(SUPPORTED_PROPERTY_STATUSES);
        }
    }
