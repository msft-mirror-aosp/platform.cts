...
public class DetailedErrorCodeTest {
    ...
    public void testToString() {
        ...
        assertThat(DetailedErrorCode.toString(DetailedErrorCode.NOT_AVAILABLE_DISABLED))
                .isEqualTo("NOT_AVAILABLE_DISABLED");
        assertThat(DetailedErrorCode.toString(DetailedErrorCode.NOT_AVAILABLE_SPEED_LOW))
                .isEqualTo("NOT_AVAILABLE_SPEED_LOW");
        assertThat(DetailedErrorCode.toString(DetailedErrorCode.NOT_AVAILABLE_SPEED_HIGH))
                .isEqualTo("NOT_AVAILABLE_SPEED_HIGH");
        assertThat(DetailedErrorCode.toString(DetailedErrorCode.NOT_AVAILABLE_POOR_VISIBILITY))
    ...
    public void testAllDetailedErrorCodesAreMappedInToString() {
        ...
        for (Integer errorCode : detailedErrorCodes) {
            ...
            assertWithMessage("%s should be non-empty ", detailedErrorCodeString)
                    .that(detailedErrorCodeString.isEmpty())
                    .isFalse();
        }
    }
}
