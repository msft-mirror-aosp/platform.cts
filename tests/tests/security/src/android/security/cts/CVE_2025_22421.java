...
public class CVE_2025_22421 extends StsExtraBusinessLogicTestCase {
    ...
    public void testPocCVE_2025_22421() {
        try {
            ...
            // Load the 'StatusBarIconView' class.
            final Class statusBarIconViewClass =
                    systemUiContext
                            .getClassLoader()
                            .loadClass("com.android.systemui.statusbar.StatusBarIconView");
            ...
            final Method contentDescForNotification =
                    statusBarIconViewClass.getDeclaredMethod(
                            "contentDescForNotification", Notification.class, Context.class);
            ...
            final String fetchedValue =
                    (String) contentDescForNotification.invoke(null, notification, systemUiContext);
