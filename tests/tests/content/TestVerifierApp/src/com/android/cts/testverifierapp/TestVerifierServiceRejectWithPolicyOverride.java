...
public class TestVerifierServiceRejectWithPolicyOverride extends TestVerifierService {
    ...
    public void onVerificationRequired(VerificationSession session) {
        ...
        // First override the session policy
        session.setVerificationPolicy(PackageInstaller.VERIFICATION_POLICY_NONE);
        // Then return verification failure to reject the installation
