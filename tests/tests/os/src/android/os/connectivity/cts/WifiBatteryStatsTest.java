...
public class WifiBatteryStatsTest {
    ...
    public void parceling() throws Throwable {
        WifiBatteryStats stats = new WifiBatteryStats(100L, 200L, 300L, 400L, 500L, 600L, 700L,
                800L, 900L, 1000L, 2000L, 3000L, 4000L, new long[]{2000, 3000},
                new long[]{4000, 5000}, new long[]{6000, 7000, 8000}, 8000L);
        ...
        WifiBatteryStats actual = WifiBatteryStats.CREATOR.createFromParcel(in);
        ...
        assertThat(actual.getScanTimeMillis()).isEqualTo(800);
        assertThat(actual.getIdleTimeMillis()).isEqualTo(900);
        assertThat(actual.getRxTimeMillis()).isEqualTo(1000);
        assertThat(actual.getTxTimeMillis()).isEqualTo(2000);
        assertThat(actual.getEnergyConsumedMaMillis()).isEqualTo(3000);
        assertThat(actual.getAppScanRequestCount()).isEqualTo(4000);
        assertThat(actual.getMonitoredRailChargeConsumedMaMillis()).isEqualTo(8000);
    }
}
