...
public class NativeSystemFontTest {
    ...
    /** Converts a set of Font objects to a set of FontDescriptor objects. */
    ...
    public void testMatchFamilyStyleCharacter_fallback() {
        Pair<File, Integer> fontForA =
                NativeSystemFontHelper.matchFamilyStyleCharacter(
                        ...
                        false,
                        "en-US",
                        0 /* default family variant */,
                        "A");
        Pair<File, Integer> fontForB =
                NativeSystemFontHelper.matchFamilyStyleCharacter(
                        "Another-Unknown-Generic-Family",
                        400,
                        false,
                        "en-US",
                        0 /* default family variant */,
