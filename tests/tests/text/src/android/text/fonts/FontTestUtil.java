 ...
 *
 * <p>For the purpose of testing font selection of families or fallbacks, this class provies
 * following regular font files.
 *
 * <p>- ascii_a3em_weight100_upright.ttf 'a' has 3em width and others have 1em width. The metadata
 * has weight=100, non-italic value. - ascii_b3em_weight100_italic.ttf 'b' has 3em width and others
 * have 1em width. The metadata has weight=100, italic value. - ascii_c3em_weight200_upright.ttf 'c'
 * has 3em width and others have 1em width. The metadata has weight=200, non-italic value. -
 * ascii_d3em_weight200_italic.ttf 'd' has 3em width and others have 1em width. The metadata has
 * weight=200, italic value. - ascii_e3em_weight300_upright.ttf 'e' has 3em width and others have
 * 1em width. The metadata has weight=300, non-italic value. - ascii_f3em_weight300_italic.ttf 'f'
 * has 3em width and others have 1em width. The metadata has weight=300, italic value. -
 * ascii_g3em_weight400_upright.ttf 'g' has 3em width and others have 1em width. The metadata has
 * weight=400, non-italic value. - ascii_h3em_weight400_italic.ttf 'h' has 3em width and others have
 * 1em width. The metadata has weight=400, italic value. - ascii_i3em_weight500_upright.ttf 'i' has
 * 3em width and others have 1em width. The metadata has weight=500, non-italic value. -
 * ascii_j3em_weight500_italic.ttf 'j' has 3em width and others have 1em width. The metadata has
 * weight=500, italic value. - ascii_k3em_weight600_upright.ttf 'k' has 3em width and others have
 * 1em width. The metadata has weight=600, non-italic value. - ascii_l3em_weight600_italic.ttf 'l'
 * has 3em width and others have 1em width. The metadata has weight=600, italic value. -
 * ascii_m3em_weight700_upright.ttf 'm' has 3em width and others have 1em width. The metadata has
 * weight=700, non-italic value. - ascii_n3em_weight700_italic.ttf 'n' has 3em width and others have
 * 1em width. The metadata has weight=700, italic value. - ascii_o3em_weight800_upright.ttf 'o' has
 * 3em width and others have 1em width. The metadata has weight=800, non-italic value. -
 * ascii_p3em_weight800_italic.ttf 'p' has 3em width and others have 1em width. The metadata has
 * weight=800, italic value. - ascii_q3em_weight900_upright.ttf 'q' has 3em width and others have
 * 1em width. The metadata has weight=900, non-italic value. - ascii_r3em_weight900_italic.ttf 'r'
 * has 3em width and others have 1em width. The metadata has weight=900, italic value.
 *
 * <p>In addition to above font files, this class provides a font collection file and a variable
 * font file. - ascii.ttc The collection of above 18 fonts with above order. - ascii_vf.ttf This
 * font supports a-z characters and all characters has 1em width. This font supports 'wght', 'ital'
 * axes but no effect for the glyph width. This font also supports 'Asc[a-z]' 26 axes which makes
 * glyph width 3em. For example, 'Asca 1.0' makes a glyph width of 'a' 3em, 'Ascb 1.0' makes a glyph
 * width of 'b' 3em. With these axes, above font can be replicated like - 'Asca' 1.0, 'wght' 100.0'
 * is equivalent with ascii_a3em_width100_upright.ttf - 'Ascb' 1.0, 'wght' 100.0, 'ital' 1.0' is
 * equivalent with ascii_b3em_width100_italic.ttf
 */
public class FontTestUtil {
    ...
    private static int getSelectedFontStyle(Typeface typeface) {
        ...
        for (int i = 0; i < CHAR_3EM_WIDTH.length; ++i) {
            if (measureChar(typeface, CHAR_3EM_WIDTH[i]) == 300.0f) {
                assertEquals(
                        "A font has two 3em width character. Likely the wrong test setup.",
                        -1,
                        indexOf3Em);
                indexOf3Em = i;
            }
        ...
        assertNotEquals(
                "No font has 3em width character. Likely the wrong test setup.", -1, indexOf3Em);
        return indexOf3Em;
    }
     ...
     *
     * <p>Note that this is valid only if the all Font objects in the FontFamily is created with
     * AssetManager.
     */
     ...
     *
     * <p>Note that this is valid only if the all Font objects in the FontFamily is created with TTC
     * font with ttcIndex.
     */
