...
public final class FontFamilyUpdateRequestTest {
    ...
    public void font() {
        ...
        List<FontVariationAxis> axes =
                Arrays.asList(
                        new FontVariationAxis("wght", 100f), new FontVariationAxis("wdth", 100f));
        ...
        assertThrows(
                NullPointerException.class,
                () -> new FontFamilyUpdateRequest.Font.Builder(postScriptName, null).setAxes(axes));
        assertThrows(
                NullPointerException.class,
                () ->
                        new FontFamilyUpdateRequest.Font.Builder(postScriptName, style)
    ...
    public void fontFamily() {
        ...
        FontFamilyUpdateRequest.Font font1 =
                new FontFamilyUpdateRequest.Font.Builder(
                                "Test", new FontStyle(FONT_WEIGHT_NORMAL, FONT_SLANT_UPRIGHT))
                        .build();
        FontFamilyUpdateRequest.Font font2 =
                new FontFamilyUpdateRequest.Font.Builder(
                                "Test", new FontStyle(FONT_WEIGHT_NORMAL, FONT_SLANT_ITALIC))
                        .build();
        FontFamilyUpdateRequest.FontFamily fontFamily =
                new FontFamilyUpdateRequest.FontFamily.Builder(
                                name, Collections.singletonList(font1))
                        .addFont(font2)
                        .build();
        ...
        assertThrows(
                ...
                () ->
                        new FontFamilyUpdateRequest.FontFamily.Builder(
                                        name, Collections.singletonList(null))
                                .build());
    }
    ...
    public void fontFamilyUpdateRequest() throws Exception {
        ...
        List<FontFamilyUpdateRequest.Font> fonts =
                Arrays.asList(
                        new FontFamilyUpdateRequest.Font.Builder(
                                        "Roboto-Regular",
        ...
        FontFamilyUpdateRequest request =
                new FontFamilyUpdateRequest.Builder()
                        ...
                        .build();
        assertThat(request.getFontFileUpdateRequests()).containsExactly(fontFileUpdateRequest);
