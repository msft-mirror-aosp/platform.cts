...
public class FontManagerTest {
    ...
    private static void updateFontFile(
            FontManager fm, FontFileUpdateRequest ffur, int baseVersion) {
        fm.updateFontFamily(
    ...
    public void fontManager_updateFontFamily_negativeBaseVersion() {
        ...
        try {
            ...
            FontFamilyUpdateRequest.FontFamily family =
                    new FontFamilyUpdateRequest.FontFamily.Builder("test", Arrays.asList(font))
                            .build();
            FontFamilyUpdateRequest request =
                    new FontFamilyUpdateRequest.Builder().addFontFamily(family).build();
            fm.updateFontFamily(request, -1);
            fail("IllegalArgumentException is expected.");
        } catch (IllegalArgumentException e) {
            // pass
        }
    ...
    public void fontManager_updateFontFamily_permissionEnforce() {
        ...
        try {
            ...
            FontFamilyUpdateRequest request =
                    new FontFamilyUpdateRequest.Builder().addFontFamily(family).build();
            fm.updateFontFamily(request, fm.getFontConfig().getConfigVersion());
            fail("SecurityException is expected.");
        } catch (SecurityException e) {
            // pass
        }
    ...
    private static void insertFontFamilyBefore(
            FontManager fm,
            FontFileUpdateRequest ffur,
            FontFamilyUpdateRequest.FontFamily fontFamily,
            String fontFamilyToInsertBefore,
            int baseVersion) {
        fm.insertFontFamilyBefore(
                new FontFamilyUpdateRequest.Builder()
                        .addFontFileUpdateRequest(ffur)
                        .addFontFamily(fontFamily)
                        .build(),
                fontFamilyToInsertBefore,
                baseVersion);
    }

    @Test
    @RequiresFlagsEnabled(com.android.text.flags.Flags.FLAG_INSERT_FONT_FAMILY)
    public void fontManager_insertFontFamilyBefore_negativeBaseVersion() throws Exception {
        FontManager fm = getContext().getSystemService(FontManager.class);
        assertThat(fm).isNotNull();
        ...
        try {
            FontFileUpdateRequest fontFileUpdateRequest =
                    new FontFileUpdateRequest(pfd, new byte[256]);
            ...
            insertFontFamilyBefore(fm, fontFileUpdateRequest, fontFamily, "NotoColorEmoji", -1);
            fail("IllegalArgumentException is expected.");
        } catch (IllegalArgumentException e) {
            // pass
        }
    ...
    @Test
    @RequiresFlagsEnabled(com.android.text.flags.Flags.FLAG_INSERT_FONT_FAMILY)
    public void fontManager_insertFontFamilyBefore_permissionEnforce() throws Exception {
        FontManager fm = getContext().getSystemService(FontManager.class);
        assertThat(fm).isNotNull();
                    ...
                    new FontFamilyUpdateRequest.FontFamily.Builder(
                                    ...
                                    Arrays.asList(
                                            new FontFamilyUpdateRequest.Font.Builder(
                                                    ...
                                                    .build()))
                            .build();
            insertFontFamilyBefore(
                    fm,
                    fontFileUpdateRequest,
                    fontFamily,
                    "NotoColorEmoji",
                    fm.getFontConfig().getConfigVersion());
            fail("SecurityException is expected.");
    ...
    public void fontManager_NotoColorEmojiAvailable() throws IOException {
        ...
        assertWithMessage(
                        "NotoColorEmoji must be included."
