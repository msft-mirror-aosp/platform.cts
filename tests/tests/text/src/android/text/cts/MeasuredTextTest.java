...
public class MeasuredTextTest {
    ...
    public void testBuilder() {
        ...
        LineBreakConfig config =
                new LineBreakConfig.Builder()
                        ...
                        .build();
        new MeasuredText.Builder(text.toCharArray())
                .appendStyleRun(sPaint, config, text.length(), false /* isRtl */)
                .build();
    }
    ...
    public void testBuilder_FromExistingMeasuredText() {
        ...
        assertNotNull(
                new MeasuredText.Builder(mt)
                        .appendStyleRun(sPaint, text.length(), true /* isRtl */)
                        .build());
    }
    ...
    /** Creates a bitmap by drawing the given text using SpannableStringBuilder. */
    public Bitmap makeBitmapFromSsb(String text, TextPaint paint, boolean isRtl) {
        ...
        ssbCanvas.drawTextRun(
                ssb, 0, ssb.length(), 0, ssb.length(), 0.0f /* x */, 240.0f /* y */, isRtl, paint);
        ssbCanvas.restore();
        return ssbBitmap;
    }

    /** Creates a bitmap by drawing the given text using MeasuredText with same paint. */
    public Bitmap makeBitmapFromMtWithSamePaint(String text, TextPaint paint, boolean isRtl) {
        ...
        mtCanvas.drawTextRun(
                mt, 0, text.length(), 0, text.length(), 0.0f /* x */, 240.0f /* y */, isRtl, paint);
        mtCanvas.restore();
        return mtBitmap;
    }

    /** Creates a bitmap by drawing the given text using MeasuredText with different paint. */
    ...
    /** Creates a bitmap by drawing the given text using PrecomputedText. */
    public Bitmap makeBitmapFromPct(String text, TextPaint paint, boolean isRtl) {
        final PrecomputedText pct =
                PrecomputedText.create(text, new PrecomputedText.Params.Builder(paint).build());
