...
import android.text.fonts.FontFileTestUtil;
...
public class TypefaceTest {
    ...
    /**
     * Create a typeface of the given style. If the default font does not support the style, a
     * number of generic families are tried.
     *
    ...
    public void testGetSystemFontFamilyName() throws Exception {
        ...
        Typeface sansSerifWeightItalicBold = Typeface.create(sansSerifWeightItalic, Typeface.BOLD);
        ...
        Typeface typefaceFromAsset =
                Typeface.createFromAsset(mContext.getAssets(), "fonts/others/samplefont.ttf");
    ...
    public void testInvalidCmapFont() {
        Typeface typeface =
                Typeface.createFromAsset(mContext.getAssets(), "fonts/security/bombfont.ttf");
        assertNotNull(typeface);
    ...
    public void testInvalidCmapFont2() {
        Typeface typeface =
                Typeface.createFromAsset(mContext.getAssets(), "fonts/security/bombfont2.ttf");
        assertNotNull(typeface);
        final String testString = "abcde";
        float widthDefaultTypeface = measureText(testString, Typeface.DEFAULT);
        float widthCustomTypeface = measureText(testString, typeface);
    ...
    public void testCreateFromAsset_cachesTypeface() {
        ...
        Typeface typeface3 =
                Typeface.createFromAsset(mContext.getAssets(), "fonts/others/samplefont2.ttf");
        assertNotNull(typeface3);
        assertNotSame(
                "Different font asset should return different Typeface object",
                typeface2,
                typeface3);

        Typeface typeface4 =
                Typeface.createFromAsset(mContext.getAssets(), "fonts/others/samplefont3.ttf");
    ...
    public void testBadFont() {
        Typeface typeface =
                Typeface.createFromAsset(mContext.getAssets(), "fonts/security/ft45987.ttf");
        assertNotNull(typeface);
    }
    ...
    public void testTypefaceBuilder_AssetSource() {
        Typeface typeface1 =
                new Typeface.Builder(mContext.getAssets(), "fonts/others/samplefont.ttf").build();
        assertNotNull(typeface1);
        ...
        Typeface typeface3 =
                new Typeface.Builder(mContext.getAssets(), "fonts/others/samplefont2.ttf").build();
        assertNotNull(typeface3);
        assertNotSame(
                "Different font asset should return different Typeface object",
                typeface2,
        ...
        Typeface typeface4 =
                new Typeface.Builder(mContext.getAssets(), "fonts/others/samplefont3.ttf").build();
        assertNotNull(typeface4);
        assertNotSame(
                "Different font asset should return different Typeface object",
                typeface2,
        ...
        Typeface typeface5 =
                new Typeface.Builder(mContext.getAssets(), "fonts/others/samplefont.ttf")
                        .setFontVariationSettings("'wdth' 1.0")
                        .build();
        assertNotNull(typeface5);
        assertNotSame(
                "Different font font variation should return different Typeface object",
                typeface2,
                typeface5);

        Typeface typeface6 =
                new Typeface.Builder(mContext.getAssets(), "fonts/others/samplefont.ttf")
                        .setFontVariationSettings("'wdth' 2.0")
                        .build();
    ...
    public void testTypefaceBuilder_FileSource() {
        try {
            ...
            Typeface typeface3 =
                    new Typeface.Builder(file).setFontVariationSettings("'wdth' 1.0").build();
            assertNotNull(typeface3);
    ...
    public void testTypefaceBuilder_fallback() throws IOException {
        ...
        assertNull(
                new Typeface.Builder(validFile)
                        .setTtcIndex(100 /* non-existing ttc index */)
                        .build());
        ...
        Typeface sansSerifTypeface =
                new Typeface.Builder(invalidFile).setFallback("sans-serif").build();
        ...
        Typeface boldSansSerifTypeface =
                new Typeface.Builder(invalidFile).setFallback("sans-serif").setWeight(700).build();
        assertNotNull(boldSansSerifTypeface);

        Typeface boldSerifTypeface =
                new Typeface.Builder(invalidFile).setFallback("serif").setWeight(700).build();
        assertNotNull(boldSerifTypeface);

        Typeface italicSansSerifTypeface =
                new Typeface.Builder(invalidFile).setFallback("sans-serif").setItalic(true).build();
        assertNotNull(italicSansSerifTypeface);

        Typeface italicSerifTypeface =
                new Typeface.Builder(invalidFile).setFallback("serif").setItalic(true).build();
    ...
    public void testTypefaceBuilder_customFallback() {
        ...
        final Typeface regularTypeface =
                new Typeface.Builder(mContext.getAssets(), fontPath).setWeight(400).build();
        final Typeface blackTypeface =
                new Typeface.Builder(mContext.getAssets(), fontPath).setWeight(900).build();
    ...
    public void testFontVariationSettings() {
        ...
        paint.setTypeface(
                new Typeface.Builder(am, "fonts/var_fonts/WeightEqualsEmVariableFont.ttf")
                        .setFontVariationSettings("'wght' 0")
                        .build());
        ...
        paint.setTypeface(
                new Typeface.Builder(am, "fonts/var_fonts/WeightEqualsEmVariableFont.ttf")
                        .setFontVariationSettings("'wght' 550")
                        .build());
    ...
    public void testFontVariationSettings_UnsupportedAxes() {
        ...
        paint.setTypeface(
                new Typeface.Builder(am, "fonts/var_fonts/WeightEqualsEmVariableFont.ttf")
                        .setFontVariationSettings("'wght' 300, 'wdth' 10")
                        .build());
        assertEquals(30.0f, paint.measureText("a"), 0.0f);

        paint.setTypeface(
                new Typeface.Builder(am, "fonts/var_fonts/WeightEqualsEmVariableFont.ttf")
                        .setFontVariationSettings("'wdth' 10, 'wght' 300")
                        .build());
        assertEquals(30.0f, paint.measureText("a"), 0.0f);
    }
    ...
    public void testFontVariationSettings_OutOfRangeValue() {
        ...
        paint.setTypeface(
                new Typeface.Builder(am, "fonts/var_fonts/WidthEqualsEmVariableFont.ttf")
                        .setFontVariationSettings("'wdth' -100")
                        .build());
        assertEquals(0.0f, paint.measureText("a"), 0.0f);

        paint.setTypeface(
                new Typeface.Builder(am, "fonts/var_fonts/WidthEqualsEmVariableFont.ttf")
                        .setFontVariationSettings("'wdth' 1300")
                        .build());
    ...
    public void testTypefaceCreate_customFont_getWeight() {
        ...
        Typeface typeface =
                new Builder(am, "fonts/family_selection/ttf/ascii_a3em_weight100_upright.ttf")
                        .build();
        assertEquals(100, typeface.getWeight());
        assertFalse(typeface.isItalic());

        typeface =
                new Builder(am, "fonts/family_selection/ttf/ascii_b3em_weight100_italic.ttf")
                        .build();
        assertEquals(100, typeface.getWeight());
        assertTrue(typeface.isItalic());
    }
    ...
    /**
     * Returns effective weight value from the variation settings. Return NO_SETTINGS value is no
     * weight value is set to variation settings.
     */
    ...
    public void testEffectiveWeight() {
        ...
        assertWeight(
                400,
                Typeface.create(Typeface.create("sans-serif-thin", Typeface.NORMAL), 400, false));
        assertWeight(
                400,
                Typeface.create(Typeface.create("sans-serif-medium", Typeface.NORMAL), 400, false));
        assertWeight(
                400,
