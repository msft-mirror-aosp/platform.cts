...
public class LineBreakerTest {
    ...
    public void testSetGet_JustificationMode() {
        assertEquals(
                JUSTIFICATION_MODE_NONE, new LineBreaker.Builder().build().getJustificationMode());
        assertEquals(
    ...
    public void testSetJustification_shouldNotThrowExceptions() {
        assertNotNull(
                new LineBreaker.Builder().setJustificationMode(JUSTIFICATION_MODE_NONE).build());
        assertNotNull(
                new LineBreaker.Builder()
                        .setJustificationMode(JUSTIFICATION_MODE_INTER_WORD)
                        .build());
    ...
    public void testLineBreak_Simple_indents() {
        ...
        final LineBreaker lb =
                new LineBreaker.Builder()
                        .setBreakStrategy(BREAK_STRATEGY_SIMPLE)
                        .setIndents(
                                new int[] {50, 0}) // The first line indent is 50 and 0 for others.
                        .build();
        final ParagraphConstraints c = new ParagraphConstraints();
        c.setWidth(100.0f);
        final Result r =
    ...
    public void testLineBreak_HighQuality_Hyphenation_NoHyphenation() {
        ...
        final ParagraphConstraints c = new ParagraphConstraints();
        c.setWidth(170);
        LineBreakConfig noHyphenConfig =
