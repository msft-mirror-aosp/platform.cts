...
public class FontVariationAxisTest {
    ...
    public void testtoFontVariationSettings() {
        assertEquals("", FontVariationAxis.toFontVariationSettings((FontVariationAxis[]) null));
        assertEquals("", FontVariationAxis.toFontVariationSettings(new FontVariationAxis[0]));

        final FontVariationAxis[] axes = {
            new FontVariationAxis("wght", 1.0f), new FontVariationAxis("PRIV", 3.0f)
        };
    ...
    public void testEquals() {
        ...
        assertFalse(
                new FontVariationAxis("wght", 1.0f).equals(new FontVariationAxis("slnt", 1.0f)));
    }
