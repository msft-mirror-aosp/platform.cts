...
jlong nGetNext(JNIEnv*, jclass, jlong ptr) {
    return reinterpret_cast<jlong>(
            ASystemFontIterator_next(reinterpret_cast<ASystemFontIterator*>(ptr)));
}
...
int register_android_text_fonts_cts_SystemFontTest(JNIEnv* env) {
    jclass clazz = env->FindClass("android/text/fonts/NativeSystemFontHelper");
