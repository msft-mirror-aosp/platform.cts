...
public class AudioMixTest {
    ...
    private static final AudioFormat OUTPUT_FORMAT_STEREO_48KHZ_DEFAULT =
            new AudioFormat.Builder()
                    .setSampleRate(48000)
                    .setChannelMask(CHANNEL_OUT_STEREO)
                    .setEncoding(ENCODING_DEFAULT).build();
    ...
    private static final AudioAttributes AUDIO_ATTRIBUTES_MEDIA_MUSIC =
    ...
    public void testEquals() {
        ...
        // -- Equality group 6
        final AudioMix playbackAudioMixWithMediaUsage = new AudioMix.Builder(
                new AudioMixingRule.Builder()
                        .excludeRule(AUDIO_ATTRIBUTES_MEDIA_MUSIC,
                                AudioMixingRule.RULE_MATCH_ATTRIBUTE_USAGE)
                        .build())
                .setDevice(AudioSystem.DEVICE_BIT_DEFAULT, "device-address")
                .setFormat(OUTPUT_FORMAT_STEREO_48KHZ_DEFAULT)
