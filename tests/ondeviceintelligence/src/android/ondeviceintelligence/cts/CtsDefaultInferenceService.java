...
/**
 * A default implementation of {@link OnDeviceSandboxedInferenceService} that only overrides the
 ...
 */
public class CtsDefaultInferenceService extends OnDeviceSandboxedInferenceService {
    ...
    public void onProcessRequest(int callerUid, @NonNull Feature feature, @Nullable Bundle request,
            ...
            @Nullable ProcessingSignal processingSignal, @NonNull ProcessingCallback callback) {
        callback.onResult(Bundle.EMPTY);
    }
