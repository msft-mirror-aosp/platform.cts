...
"""Verifies sensitivities on RAW images for AE ISO priority mode."""
...
class SensorSensitivityPriorityTest(its_base_test.ItsBaseTest):
  """Capture a set of raw images with increasing gains & measure noise.
  """
  ...
  def test_sensor_sensitivity_priority(self):
    ...
    with its_session_utils.ItsSession(
      ...
      camera_properties_utils.skip_unless(
          ...
          (_CONTROL_AE_PRIORITY_MODE_SENSOR_SENSITIVITY_PRIORITY in
      ...
      for s in sensitivities:
        req = ae_iso_priority_capture_request(s)
      ...
      # Assert each set of shots is noisier than previous
