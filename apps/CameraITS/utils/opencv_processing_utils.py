...
CHART_DISTANCE_WITH_SCALING_RULES = types.MappingProxyType({
    ...
    CHART_DISTANCE_31CM: {
        ...
        (FOV_THRESH_TELE31+EPSILON, FOV_THRESH_TELE45): SCALE_CHART_50_PERCENT,
        (FOV_THRESH_TELE45+EPSILON, FOV_THRESH_TELE): SCALE_CHART_67_PERCENT,
    },
    CHART_DISTANCE_50CM: {
