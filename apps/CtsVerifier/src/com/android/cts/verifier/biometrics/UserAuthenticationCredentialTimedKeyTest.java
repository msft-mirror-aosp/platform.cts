...
public class UserAuthenticationCredentialTimedKeyTest
        extends AbstractUserAuthenticationTimedKeyTest {

    private static final String TAG = UserAuthenticationCredentialTimedKeyTest.class.getName();
