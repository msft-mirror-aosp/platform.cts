...
public class MultiLineChart extends View {
    ...
    private int mLineColor = 0xFF039BE5;
    ...
    protected void onDraw(Canvas canvas) {
        ...
        canvas.drawRect(0.0f, 0.0f, getWidth(), getHeight(), mBackgroundPaint);
    ...
    void drawTrace(Canvas canvas, Trace trace) {
        ...
        canvas.drawLines(
                mSecondaryColorVertices, 0, secondaryColorVertexIndex, trace.secondaryPaint);
    }
    ...
    public MultiLineChart.Trace createTrace(
            String name, int color, int secondaryColor, float min, float max) {
    ...
    public static class Trace {
        ...
        private Trace(
                String name, int color, int secondaryColor, int numValues, float min, float max) {
            mName = name;
            mMin = min;
            mMax = max;
        ...
        /**
         * Fetch a previous value. A delayIndex of 1 will return the most recently written value. A
         * delayIndex of 2 will return the previously written value;
         *
    ...
    private static class CircularFloatArray {
        ...
        CircularFloatArray(int numValuesPowerOf2) {
            if ((numValuesPowerOf2 & (numValuesPowerOf2 - 1)) != 0) {
                throw new IllegalArgumentException(
                        "numValuesPowerOf2 not 2^N, was " + numValuesPowerOf2);
            }
        ...
        /**
         * Add one value to the array. This may overwrite the oldest data.
         *
         * @param value value to add
         * @param useSecondaryColor whether to use the secondary color
         */
        void add(float value, boolean useSecondaryColor) {
         ...
         * @return old value
         */
        float get(int delayIndex) {
            int index = (mCursor - delayIndex) & mIndexMask;
            return mData[index];
        }

        boolean getUseSecondaryColor(int delayIndex) {
            int index = (mCursor - delayIndex) & mIndexMask;
