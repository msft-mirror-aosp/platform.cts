...
class UsbMultipleDeviceWarningDialog extends Dialog implements OnClickListener {
    private static final String TAG = "AudioLoopbackCalibrationDialog";

    private Context mContext;
    private WebView mMessageView;

    UsbMultipleDeviceWarningDialog(Context context) {
        super(context);
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setTitle(mContext.getString(R.string.usbwarning_message_caption_for_multiple_interfaces));
        ...
        htmlFormatter
                ...
                .appendText(
                        mContext.getString(
                                R.string.usbwarning_message_heading_for_multiple_interfaces))
                .closeHeading(3);

        htmlFormatter
                .openParagraph()
                .appendText(
                        mContext.getString(R.string.usbwarning_paragraph_for_multiple_interfaces))
                .closeParagraph();
