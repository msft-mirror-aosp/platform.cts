...
class Synthesizer {
public:
    Synthesizer() : mMaxVoices(0), mActiveVoiceCount(0), mVoices(NULL) {}

    virtual ~Synthesizer() { delete[] mVoices; };
    ...
    void allNotesOn() { notesOn(mMaxVoices); }
    ...
    int32_t getActiveVoiceCount() { return mActiveVoiceCount; }
